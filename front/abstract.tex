...
precise communication, contributing to misunderstandings when researching,
planning, and performing testing. In this \docType{}, we %systematically
...
\begin{enumerate}
    ...
    \item capturing relevant testing terms from these sources, along with their
          \ifnotpaper \newline \fi definitions and relationships (both explicit
          and implicit), and
    \item constructing visualizations to analyze these data.
\end{enumerate}
This process uncovered \approachCount{} test approaches and
\ifnotpaper four in-scope methods for deriving test approaches, such as those
    ...
    imply additional related test approaches\fi. We also manually record flaws
as they arise and build tools to detect more flaws automatically, analyze all
of our recorded flaw data, and visualize the relations between test approaches.
% and track flaws both by detecting them automatically using this tool and by
% manually recording them throughout our research process.
This revealed \flawCount{} flaws,
...
synonyms or have a parent-child relationship. We also found notable
confusion surrounding functional testing, \ifnotpaper operational acceptance
    testing, \fi recovery testing, and scalability testing. Our
