...
\def\conceptResults{These concepts follow logically from the literature and as
    such are technically ``results'' of our research, but we define them here for
...
\def\parSheetTestFlaw{``Par sheet testing'' from \citepISTQB{} seems to refer
    ...
    \citep{Bluejay2024}.\todo{Is this a scope flaw?}}
