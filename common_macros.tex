...
\NewDocumentCommand{\parSynFlaw}{s}{%
    ...
    other; these relations cannot coexist as synonym relations are symmetric
...
\def\errorGuessFlaw{Since errors are distinct from defects/faults \ifnotpaper
    ...
    \cite[p.~12\=/3]{SWEBOK2025}, \cite[pp.~128, 140]{IEEE2010},
...
\citep[p.~5\=/13]{SWEBOK2025}. One (or both) of these proposed terms
