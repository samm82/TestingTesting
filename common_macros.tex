...
\def\parSynFlaw{these are flaws since synonym relations are symmetric while
    parent-child relations are asymmetric as outlined in
...
\NewDocumentCommand\parSynIntro{s}{%
    ...
    as a subapproach of the other; \parSynFlaw{}.
