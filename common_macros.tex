...
\def\tourDiscrep{The structure of tours is quite general
    \citep[p.~34]{IEEE2022} or ``organized around a special focus'' \citepISTQB{}.}
...
\def\graphGenDesc{
    ...
    subsets of them. \ifnotpaper Graphs limited to approaches from a given
        ...
        \citet[Fig.~2]{IEEE2022} \multAuthHelper{consider} static testing a
