...
\end{itemize}
An excellent style manual for science writers is \textit{The Technical Writer's Handbook}.
...
\begin{figure}[htbp]
    \centerline{\includegraphics[width=\columnwidth]{assets/images/cas_logo}}
...
number; do not use ``Ref. [1]'' or ``reference [1]'' except at
