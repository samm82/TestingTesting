...
\begin{abstract}
    ...
    or ambiguities, including ten terms given as synonyms to two (or more)
    disjoint test approaches and 14 pairs of test approaches may be synonyms
    and/or have a child-parent relationship. There is also confusion
    surrounding functional, recovery, scalability, and performance testing,
    along with 45 ``smaller'' discrepancies. Overall, there is a need for
    testing terminology to be standardized to make the discussion, analysis,
    and implementation of various test approaches more coherent. We
