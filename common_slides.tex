        ...
        \begin{column}{0.63\textwidth}
            ...
            \begin{tikzpicture}[scale=0.8]
                \begin{axis}[
                        ...
                        nodes near coords,
                        legend style={at={(0.5,-0.37)}, anchor=north,legend columns=-1,
                                % From https://tex.stackexchange.com/a/18162/192195
                                /tikz/every even column/.append style={column sep=0.5cm}},
                        legend entries={Found, Not Found},
...
\begin{frame}{Flaw Summary by Source Tier}
    \only{\begin{figure}
        ...
        \end{figure}}<1>
    \only{\input{assets/graphs/flawBarsSem}}<2>
\end{frame}
...
\begin{frame}{Flaws by Source Tier Observations}
    \srcTierObservs{}
\end{frame}

\begin{frame}{Flaw Summary by Manifestation}
    \begin{center}
        \input{assets/graphs/flawMnfstBarsSummary}\hspace{18cm}\vspace*{-8mm}
    \end{center}
\end{frame}
...
\begin{frame}{General Flaw Observations}
    % Seminar argument to suppress section references
    \begin{enumerate}
        \item \contraSummary[seminar]{}
        \item \catsSummary[seminar]{}
        \item \semFlaws{}
    \end{enumerate}
\end{frame}
