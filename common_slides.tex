...
\begin{frame}{Methodology}
    ...
    \begin{enumerate}
        ...
        \item Analyze recorded test approach data for additional flaws
              \begin{enumerate}
                  \item Generate relation graphs
...
\begin{frame}{Conclusion}
    \begin{itemize}
        \item The software testing literature is flawed, so
              ...
              \only<1>{\vspace{0.3cm}
                  % TODO: using adjustbox here throws an error but generates desired output
