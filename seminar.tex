...
\begin{frame}
    ...
    \begin{tikzpicture}[scale=1.5]
        ...
        \onslide<2>{
            \tester{2}
            \node[draw, ellipse callout, align=center, anchor=south,
                inner xsep=-3.5em, fill=white, text width=8cm, font=\small,
            ...
            {``Alpha testing is done by `users within the organization developing
                the \mbox{software}' \citep[p.~17]{IEEE2017}.''};
        }
        ...
        \onslide<4>{
            \node[draw, ellipse callout, align=center, anchor=south,
                inner xsep=-0.5em, fill=white, text width=5cm, font=\small,
                callout absolute pointer={(0.75, 2)}] at (1.25, 2.25)
        ...
        \onslide<7>{
            \node[draw, ellipse callout, align=center, anchor=south,
                inner xsep=-2.5em, fill=white, text width=7cm, font=\small,
            ...
            {``How? Alpha testing is performed
                ...
                `in the developer's test
                environment' \citepISTQB{}, but you didn't bring anyone in.''};
        }
