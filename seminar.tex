...
\begin{frame}[t]{Methodology}
    ...
    \begin{minipage}{0.98\textwidth}
        ...
        \only<5>{\textbf{Type:} ``Testing that is focused on specific quality
            characteristics'' (\citealp[p.~15]{IEEE2022}; \citeyear[p.~7]{IEEE2021b};
        ...
        \begin{column}{.55\textwidth}
            ...
            \begin{table}[hbtp!]
                ...
                \begin{tabular}{ll} \hline
                    ...
                    E    & F (Author, 2022; implied by 2021)     \\
...
\begin{frame}{Automated Flaws}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Soak Testing:}
              \begin{itemize}
                  \item Endurance Testing {\hfill \tiny \citep[p.~39]{IEEE2021b}}
                  \item Reliability Testing {\hfill \tiny (\citealp[Tab.~2]{Gerrard2000a};
                                \citeyear[Tab.~1,~p.~26]{Gerrard2000b})}
              \end{itemize} \pause
        \item \textbf{Link Testing:}
              \begin{itemize}
                  \item Branch Testing {\hfill \tiny (implied by \citealp[p.~24]{IEEE2021b})}
