...
\begin{frame}[fragile]
    ...
    \begin{textblock}{7.25}(0.5,3.6)
        ...
        \begin{block}{\fontsize{37}{20}\selectfont Goal}
            ...
            (well understood) research software'' \citep{carette_drasil_2021}.
            \vspace{5mm}
        \end{block}
        ...
        \begin{block}{\fontsize{37}{20}\selectfont Problem}
            ...
            example:
            \begin{itemize}
                \item \citet{TebesEtAl2020a} mainly focus on parts of the
                      testing process (e.g., test goal, testable entity)
                \item \citet{UnterkalmsteinerEtAl2014} provide a foundation for
