...
\newcommand{\ExampleGraph}{
    \begin{figure*}
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            \centering
            \includegraphics[width=0.875\linewidth]{assets/graphs/SelfExampleGlossaryGraph.pdf}
            \vspace{5mm}
        ...
        \begin{subfigure}[b]{0.45\linewidth}
            \centering
            \includegraphics[width=0.75\linewidth]{assets/graphs/ParSynExampleGlossaryGraph.pdf}
            \caption{Graph generated from a .tex file containing a line starting with
...
\newcommand{\performanceGraph}{\includegraphics[width=0.8\linewidth]{assets/graphs/manual/performanceProposedGraph.pdf}}
...
\newcommand{\discrepClssTable}{\input{assets/tables/discrepClss}}
\newcommand{\discrepCatsTable}{\input{assets/tables/discrepCats}}
