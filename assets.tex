...
\newcommand{\ExampleParChdGraphs}{
    ...
    \begin{figure*}[tb!]
        ...
        \begin{subfigure}[b]{0.575\linewidth}
            ...
            \vspace{-8mm}
            \caption{Explicit graph from \\ \Cref{tab:exampleGlossary}.}
...
%                 \includegraphics[width=1.1\linewidth]{assets/graphs/expExampleGlossaryGraph.pdf}
%                 \caption{Explicit graph from\\\Cref{tab:exampleGlossary}.}
%                 % \label{fig:expExampleGraph}
%             \end{subfigure}
...
\newcommand{\ExampleFlawGraphs}{
    \begin{figure*}
        \begin{subfigure}[t]{0.15\linewidth}
            \includegraphics[width=1.8\linewidth]{assets/graphs/SelfExampleGlossaryGraph.pdf}
            \caption{Self-loop graph.}\label{fig:selfExampleGraph}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.285\linewidth}
            \centering
            \includegraphics[width=0.8\linewidth]{assets/graphs/ParSynExampleGlossaryGraph.pdf}
            \caption{Graph of a pair of terms with a \hyperref[par-chd-rels]{parent-child}
                \emph{and} \hyperref[syn-rels]{synonym} relation.}
            \label{fig:parSynExampleGraph}
        \end{subfigure}
        \hfill
        ...
        \end{subfigure}
        \caption{Example generated graphs containing \hyperref[flaw-def]{flaws}.}
        \label{fig:exampleFlawGraphs}
    \end{figure*}
}
