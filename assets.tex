...
\newcommand{\ExampleFlawGraphs}{
    \begin{figure*}
        \begin{subfigure}[t]{0.19\linewidth}
            ...
            \caption{\raggedright Self-loop visualization.}\label{fig:selfExampleGraph}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.235\linewidth}
            \centering
            \includegraphics[width=\linewidth]{assets/graphs/ParSynExampleGlossaryGraph.pdf}
            \caption{Visualization of a pair of terms with a \hyperref[par-chd-rels]{parent-child}
        ...
        \end{subfigure}
        \caption{Example generated visualizations containing \hyperref[flaw-def]{flaws}.}
