...
\NewDocumentCommand{\seeAlways}{ O{\nameref} m }{{ see #1{#2}}}
\NewDocumentCommand{\seeParAlways}{ O{\nameref} m O{} }{{ (see #1{#2}#3)}}
\NewDocumentCommand{\seeFootAlways}{ O{\nameref} m }{\footnote{See #1{#2}.}}
...
\def\sig{\textcolor{Red}{Significant}}
\def\mod{\textcolor{YellowOrange}{Moderate}}
\def\triv{\textcolor{ForestGreen}{Trivial}}
