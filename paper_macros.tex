...
\def\graphGenDesc{
    ...
    \ifnotpaper Since child-parent and synonym relations between approaches are
        ...
        \Cref{fig:exampleGraph} in the generated graph.
    ...
    \ifnotpaper These conditions are also deduced from the information parsed
        ...
        category; note that only the explicit synonym relation between E and F
        ...
        ``Rigid'' versions of graphs that exclude implicit approaches and
        relations can also be generated\todo{Should I add an example of this?}.
