    ...
    \ifnotpaper Since child-parent and synonym relations between approaches are
        ...
        \begin{table}[hbtp!]
            ...
            \begin{tabular}{ll} \hline
                Name                        & Parent(s)                                       \\ \hline
                A                           & B (Author, 0000; Author 0001), C (Author, 0000) \\
        ...
        \begin{figure}[hbtp!]
            \ExampleGraph{}
            \caption{Graph generated from the glossary entries in \Cref{tab:exampleGlossary}.}
    ...
    \ifnotpaper These conditions are also deduced from the information parsed
        ...
        \begin{table}[hbtp!]
            ...
            \begin{tabular}{ll} \hline
                ...
                E    & F (Author, 0000; implied by Author 0001) \\
                G    & H (Author, 0000), F (Author, 0002)       \\
                H    &                                          \\ \hline
            \end{tabular}
            \caption{Sample example glossary entries with only relevant columns shown.}
        ...
        \begin{figure}[hbtp!]
            \SynExampleGraph{}
            \caption{Graph generated from the glossary entries in \Cref{tab:synExampleGlossary}.}
