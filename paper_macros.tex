...
\def\alphaDiscrep{According to various sources, alpha testing can be performed
    by different people, including ``users within the organization developing
    the software'' \citep[p.~17]{IEEE2017}, ``a small, selected group of
    potential users'' \citep[p.~5-8]{SWEBOK2024}, or ``roles outside the
    development organization'' conducted ``in the developer's test
