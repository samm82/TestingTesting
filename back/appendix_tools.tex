...
resulting in ``\citep[p.~36]{IEEE2022}''.
...
logic \seeSrcCode{1aad424}{scripts/csvToGraph.py}{57}{98} so we can
...
\seeSrcCode{f33d1d2}{scripts/helpers.py}{31}.
...
\begin{itemize}
    ...
    \item a subjective inconsistency between documents with the same set of
          authors (\noHyperIEEE{}; see \Cref{fig:ieeeSourceSets}).
\end{itemize}
