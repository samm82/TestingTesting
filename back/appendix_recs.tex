    ...
    \item Introduce separate terms for the different methods of recovery which
          ...
          \begin{enumerate}
              ...
              \item from a back-up system (\emph{failover testing})
                    (\citealp[p.~5\=/9]{SWEBOK2025}; \citealpISTQB{}), or
...
\citealp[pp.~5\=/8 to 5\=/9]{SWEBOK2025}). It is performed either \dots\
\begin{enumerate}
...
In contrast, \citet[pp.~5\=/8 to 5\=/9]{SWEBOK2025}
...
``performance-related testing'' as synonyms
(\citealp[pp.~5\=/8 to 5\=/9]{SWEBOK2025}; \citealp[p.~1187]{Moghadam2019}),
as noted in \Cref{syns}. This makes sense because of how general the
