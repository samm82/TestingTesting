...
\begin{itemize}
    ...
    \item Testing for ``faults specific to \acs{php}'' is just a subcategory of
          ...
          are not exclusive to \acf{php}\qtodo{Since this is a recursive acronym
              and a pretty common language, do I need to spell this out?}.
