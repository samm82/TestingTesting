...
\begin{enumerate}
    ...
    \item End-to-end functionality testing (\citealp[p.~20]{IEEE2021b}; \citealp[Tab.~2]{Gerrard2000a})
    ...
    \item Security audits (\citealp[p.~40]{IEEE2021b}; \citealp[p.~28]{Gerrard2000b})
          % Security: Type (IEEE, 2022, pp. 9, 22, 26-27; 2021, pp. 7, 40, Tab. A.1; 2017, p. 405; OG 2013; implied by its quality (ISO/IEC, 2023a; Washizaki, 2024, p. 13-4); Firesmith, 2015, p. 53)
          % Audits: Practice?
