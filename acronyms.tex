...
\newacrs{c-use}{c-use}{Computation Data Use}
...
\newacr{dom}{Document Object Model}
\newacr{dsl}{Domain-Specific Language}
\newacrs{du-path}{du-path}{Definition-Use Path}
...
\newacrs{p-use}{p-use}{Predicate Data Use}
...
\newacrs{swebok}{SWEBOK Guide}{Guide to the SoftWare Engineering Body Of Knowledge}
\newacr{toat}{Taguchi's Orthogonal Array Testing}
