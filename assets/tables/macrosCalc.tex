...
\begin{longtblr}[
    ...
    \macro{uncatCount}              & Approaches with the generic category ``Approach''      \\*
    ...
    \hline
    \macro{TotalBefore}\TblrNote{c} & Test approaches identified before \repProc{}           \\*
    \macro{UndefBefore}\TblrNote{c} & Undefined test approaches identified before \repProc{} \\*
    \macro{TotalAfter}\TblrNote{c}  & Test approaches identified after \repProc{}            \\*
    \macro{UndefAfter}\TblrNote{c}  & Undefined test approaches identified after \repProc{}  \\
    \hline
