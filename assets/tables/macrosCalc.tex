...
\begin{longtblr}[
    note{a} = {Calculated in \LaTeX{} from values in TODO: ref source list table.},
    note{b} = {These macros are defined as counters to allow them to be used in
    ...
    \hline
    \macro{TotalBefore}\TblrNote{b}                 & Test approaches identified
    before process in \Cref{undef-terms}            & \the\TotalBefore{}                               \\
    \macro{UndefBefore}\TblrNote{b}                 & Undefined test approaches
    identified before process in \Cref{undef-terms} & \the\UndefBefore{}                               \\
    \macro{TotalAfter}\TblrNote{b}                  & Test approaches identified
    after process in \Cref{undef-terms}             & \the\TotalAfter{}                                \\
    \macro{UndefAfter}\TblrNote{b}                  & Undefined test approaches
