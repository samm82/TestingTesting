\newcommand\redunNoteHelper[1]{\ifnotpaper\vspace*{-0.4cm}\else#1\vspace*{-0.2cm}\fi}
\begin{table}[tb]
    \centering
    \begin{talltblr}[
        ...
        note{\redunNoteHelper{c}} = {\redunNoteHelper{\redunNote}},
        ...
        \redun*[c]{}          & Information is redundant                              & REDUN             \\
        \hline
    \end{talltblr}
\end{table}