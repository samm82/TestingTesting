\begin{paperTable}
    \centering
    \caption{Breakdown of \ifnotpaper identified \fi flaws by manifestation (defined in \Cref{mnfst-def})
        by source tier (defined in \Cref{source-tiers}).}\label{tab:flawMnfsts}
