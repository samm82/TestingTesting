\begin{longtblr}[
    ...
    note{e} = {This takes an optional parameter for a \texttt{note-tag} that
            corresponds to \macro{redunNote} (``\redunNote{}''; see
            \Cref{tab:macrosText})\ when used in \texttt{tabularray}s
            (i.e., \texttt{\textbackslash redun[c]\{\}}) since we omit this
            section from our paper (see \Cref{tab:macrosPaper}).},
    ...
    (in both thesis and paper)} &                                                           &
    \SetCell[c=2]{c} {\Cref{fig:sourceSummary,fig:flawBars,tab:flawMnfsts,tab:flawDmns,tab:flawTable}                                                                                                                                          \\
