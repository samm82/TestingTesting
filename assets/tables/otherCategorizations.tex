...
\begin{longtblr}[
    ...
    note{e} = {Experience-based testing may instead be a practice (\citealp[pp.~22, 34]{IEEE2022};
            \citeyear[p.~viii]{IEEE2021b}; see \Cref{tab:multiCats}).},
    ...
    \hline
    Source of Information for Designing Tests % \citep[p.~8; one other source]{IEEE2021b} 
                                 & \infoSrcExs{}               & Technique\TblrNote{e}
    % (\citealp[p.~22]{IEEE2022}; \citeyear[p.~4]{IEEE2021b};
    % \citealp[pp.~5\=/10, 5\=/13]{SWEBOK2024}; \citealpISTQB{}; \citealp[p.~46]{Firesmith2015}) 
                                 & \citep[pp.~4, 8]{IEEE2021b}                                                                  \\
    \hline
