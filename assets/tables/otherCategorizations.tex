...
\def\reasExs{Smoke Testing\\ Reuse Testing\\ Initial Testing\\ Retesting\\
    Regresstion Testing\\ Error Seeding}
...
\begin{longtblr}[
    ...
    note{g} = {\citet[p.~49]{Firesmith2015} less-than-helpfully calls this basis ``whitebox testing''.},
    note{h} = \gerrardDistinctIEEE*{type},
    note{i} = {With the exception of smoke testing, which is categorized as a technique
    ...
    \hline
    Location in Lifecycle \firesmithSubset{29} & \sdlcExs{}                 & Practice                                                                                                                                                               \\
    \hline
    ...
    \hline
    Coverage Requirement\TblrNote{g}
    \citep[pp.~4--5]{Kam2008}                  & \covReqExs{}               & Technique (\citealp[p.~5\=/13]{SWEBOK2024}; \citealp[p.~49]{Firesmith2015})                                                                                            \\
    \hline
    Category of Test Type\TblrNote{h}
    \citep[p.~12]{Gerrard2000a}                & \typeCatExs{}              & Ambiguous                                                                                                                                                              \\
    \hline
    Priority (in the context of testing e-business projects)
    \citep[p.~13]{Gerrard2000a}                & \priorExs{}                & Type\TblrNote{i} (\citealp[p.~22]{IEEE2022}; \citeyear[Tab.~A.1]{IEEE2021}; and/or implied by \citealp[p.~53]{Firesmith2015})                                          \\
    \hline
