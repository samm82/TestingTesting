...
\begin{longtblr}[
    ...
    \macroType{7}{Discrepancies} & \macro{bugPattonDiscrep}    & \Cref{intro} and \discrepref{bug-patton}                 \\*
                                 ...
                                 & \macro{tolTestingDiscrep}   & \Cref{aug-flaw-analysis} and \discrepref{ground-truth}   \\
    \hline
    ...
    \macroType{3}{RQs}           & \macro{rqatext}             & \SetCell[r=3]{l} \Cref{intro} and seminar slides         \\*
                                 ...
                                 & \macro{rqctext}             &                                                          \\
    \hline
    \macroType{6}{Misc.}         & \macro{accelTolTest}        & \macro{tolTestingDiscrep} and \Cref{hard-test}           \\*
