...
\begin{longtblr}[
    ...
    \Cref{tab:approachGlossaryExcerpt,approach-def,explicitness,procedure,orth-test,qual-test,graph-gen,aug-flaw-analysis,oat-test-rec} \\*
                             & \macro{recFigs}             & \Cref{explicitness,infers,recs}                                            \\*
                             & \macro{seeSrcCode}          & \Cref{explicitness,graph-gen,auto-flaw-analysis,paper-macros}              \\
    \hline
    \macroType{3}{RQs}       & \macro{rqatext}             & \SetCell[r=3]{l} \Cref{intro} and seminar slides                           \\*
                             & \macro{rqbtext}             &                                                                            \\*
                             & \macro{rqctext}             &                                                                            \\
    \hline
    \macroType{8}{Misc.}     & \macro{supersAck}           & \nameref{acknowledgements} and seminar slides                              \\*
                             & \macro{supers}              & \nameref{decl_aca_ach} and \macro{supersAck}                               \\*
                             & \macro{conceptResults}      & \Cref{terminology,approach-def}                                            \\*
                             & \macro{defRel}              & \Cref{syn-rels,par-chd-rels}                                               \\*
                             & \macro{defLabelDistinct}    & \Cref{label-flaw-def,labels}                                               \\*
                             & \macro{approachFields}      & \Cref{explicitness,procedure}                                              \\*
