...
\begin{longtblr}[
    ...
    \macroType{11}{Flaws\TblrNote{a}}
                             ...
                             & \macro{redBoxFlaw}          & \Cref{rigidity,wrong} and \flawref{dubious-red-box-syn}                \\*
                             & \macro{perfAsFamily}        & \Cref{method-family,classFamilyFlaw}                                   \\*
                             & \macro{tolTestFlaw}         & \Cref{aug-flaw-analysis,wrong} and \flawref{ground-truth}              \\*
    ...
    \Cref{tab:approachGlossaryExcerpt,approach-def,rigidity,procedure,orth-test,qual-test,graph-gen,aug-flaw-analysis,oat-test-rec} \\*
