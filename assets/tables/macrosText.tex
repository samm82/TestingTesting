...
\newcommand\macroType[2]{\multirow[c]{#1}{*}{\adjustbox{minipage=\the\dimexpr 0.3cm * #1 \relax,rotate=90}{#2}}}
...
\begin{longtblr}[
    ...
    \hline
    \macroType{4}{Source                                                                                                     \\
    Tiers\TblrNote{b}}       & \macro{stds}                & \SetCell[r=4]{l}
    {\Cref{fig:sourceSummary,fig:flawSources,tab:flawMnfsts,tab:flawDmns}                                                    \\\quad\\
    \Cref{flaw-analysis-example} (except for \macro{texts})}                                                                 \\*
                             & \macro{metas}               &                                                                 \\*
                             & \macro{texts}               &                                                                 \\*
