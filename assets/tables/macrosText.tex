...
\begin{longtblr}[
    ...
    note{c} = {We define a starred version, \macro{papers*}, to shorten the
    ...
    \Cref{fig:textFlawSources,fig:sourceSummary,tab:flawMnfsts,tab:flawDmns}                                                 \\*
                             & \macro{papers}\TblrNote{c}  &
    \Cref{fig:paperFlawSources,fig:sourceSummary,flaw-analysis-example,tab:flawMnfsts,tab:flawDmns}                          \\
    \hline
