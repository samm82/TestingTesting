...
\begin{longtblr}[
    ...
    \hline
    \macroType{8}{Flaws}     & \macro{bugPattonFlaw}       & \Cref{intro} and \flawref{bug-patton}                           \\*
    ...
    \macroType{5}{Source Tiers\TblrNote{a}}
                             & \macro{stds}                &
    \Cref{fig:stdFlawSources,fig:sourceSummary,flaw-analysis-example,tab:sntxFlaws,tab:smntcFlaws}                           \\*
                             & \macro{metas}               &
    \Cref{fig:metaFlawSources,fig:sourceSummary,flaw-analysis-example,tab:sntxFlaws,tab:smntcFlaws}                          \\*
                             & \macro{texts}               &
    \Cref{fig:textFlawSources,fig:sourceSummary,tab:sntxFlaws,tab:smntcFlaws}                                                \\*
                             & \macro{papers}              &
    \Cref{fig:paperFlawSources,fig:sourceSummary,flaw-analysis-example}                                                      \\*
                             & \macro{papersTbl}           & \Cref{tab:sntxFlaws,tab:smntcFlaws}                             \\
    \hline
