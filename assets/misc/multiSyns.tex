...
\begin{itemize}
    ...
    \item Negative Testing \cite{ISTQB} (implied by \cite[p.~10]{IEEE2021c})
\end{itemize}
\item \textbf{Soak Testing:}
\begin{itemize}
    \item Endurance Testing \cite[p.~39]{IEEE2021c}
...
\begin{itemize}
    \item Branch Testing (implied by \citealp[p.~24]{IEEE2021c})
