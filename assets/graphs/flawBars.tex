...
\addplot[fill=blue!60] coordinates {(std, 13) (meta, 23) (text, 0) (paper, 14)};
\addplot[fill=cyan!60] coordinates {(std, 27) (meta, 15) (text, 4) (paper, 2)};
\addplot[fill=yellow!60] coordinates {(std, 34) (meta, 2) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 7) (meta, 51) (text, 23) (paper, 26)};
\addplot[fill=red!60] coordinates {(meta, 18) (text, 13) (paper, 27)};
\addplot[fill=blue!60!cyan!60] coordinates {(text, 14) (paper, 11)};
