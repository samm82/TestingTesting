...
\addplot[fill=blue!60] coordinates {(std, 12) (meta, 23) (text, 0) (paper, 15)};
\addplot[fill=cyan!60] coordinates {(std, 28) (meta, 13) (text, 4) (paper, 5)};
\addplot[fill=yellow!60] coordinates {(std, 37) (meta, 1) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 8) (meta, 57) (text, 27) (paper, 27)};
\addplot[fill=red!60] coordinates {(meta, 22) (text, 16) (paper, 29)};
