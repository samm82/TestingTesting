...
\addplot[fill=blue!60] coordinates {(std, 12) (meta, 24) (text, 0) (paper, 14)};
\addplot[fill=cyan!60] coordinates {(std, 28) (meta, 15) (text, 4) (paper, 5)};
\addplot[fill=yellow!60] coordinates {(std, 35) (meta, 2) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 7) (meta, 52) (text, 24) (paper, 26)};
\addplot[fill=red!60] coordinates {(meta, 20) (text, 15) (paper, 29)};
