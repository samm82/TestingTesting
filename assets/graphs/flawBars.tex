...
\addplot[fill=blue!60] coordinates {(std, 11) (meta, 23) (text, 0) (paper, 11)};
\addplot[fill=cyan!60] coordinates {(std, 20) (meta, 9) (text, 5) (paper, 3)};
\addplot[fill=yellow!60] coordinates {(std, 28) (meta, 0) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 7) (meta, 43) (text, 22) (paper, 23)};
