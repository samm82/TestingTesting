...
\addplot[fill=blue!60] coordinates {(std, 13) (meta, 24) (text, 0) (paper, 14)};
\addplot[fill=cyan!60] coordinates {(std, 27) (meta, 14) (text, 6) (paper, 4)};
\addplot[fill=yellow!60] coordinates {(std, 34) (meta, 2) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 7) (meta, 50) (text, 24) (paper, 24)};
