...
\addplot[fill=blue!60] coordinates {(std, 10) (meta, 23) (text, 0) (paper, 11)};
\addplot[fill=cyan!60] coordinates {(std, 21) (meta, 11) (text, 5) (paper, 3)};
\addplot[fill=yellow!60] coordinates {(std, 28) (meta, 0) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 5) (meta, 44) (text, 22) (paper, 23)};
\addplot[fill=red!60] coordinates {(meta, 18) (text, 13) (paper, 25)};
