...
\addplot[fill=orange!60] coordinates {(std, 7) (meta, 44) (text, 22) (paper, 24)};
\addplot[fill=red!60] coordinates {(meta, 19) (text, 13) (paper, 27)};
\addplot[fill=blue!60!cyan!60] coordinates {(text, 14) (paper, 10)};
\addplot[fill=cyan!60!yellow!60] coordinates {(paper, 8)};
