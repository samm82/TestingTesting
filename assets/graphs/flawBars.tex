...
\addplot[fill=cyan!60] coordinates {(std, 27) (meta, 15) (text, 4) (paper, 5)};
\addplot[fill=yellow!60] coordinates {(std, 34) (meta, 2) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 8) (meta, 52) (text, 24) (paper, 26)};
\addplot[fill=red!60] coordinates {(meta, 19) (text, 15) (paper, 29)};
