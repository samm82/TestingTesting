...
\addplot[fill=blue!60] coordinates {(std, 13) (meta, 25) (text, 0) (paper, 14)};
\addplot[fill=cyan!60] coordinates {(std, 27) (meta, 13) (text, 6) (paper, 2)};
\addplot[fill=yellow!60] coordinates {(std, 34) (meta, 2) (text, 0) (paper, 0)};
\addplot[fill=orange!60] coordinates {(std, 7) (meta, 50) (text, 24) (paper, 25)};
\addplot[fill=red!60] coordinates {(meta, 18) (text, 12) (paper, 26)};
