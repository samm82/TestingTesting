...
StructuralTesting -> StructurebasedTesting[dir=none,color=green];
...
ReliabilityTesting -> StructuralTesting[dir=none,style=invis];
IntakeTesting -> AcceptanceTesting[dir=none,style=invis];
BranchConditionCombinationTesting -> FaultToleranceTesting[dir=none,style=invis];
DynamicTesting -> ConversionTesting -> OperationalTesting[dir=none,style=invis];
StaticTesting -> MigrationTesting -> OrthogonalArrayTesting[dir=none,style=invis];
SystemsIntegrationTesting -> PerformancerelatedTesting -> StructuredWalkthroughs[dir=none,style=invis];
...
rank = same;
edge[style=invis];
UserScenarioTesting -> DomainTesting -> CompatibilityTesting -> StructuralTesting;
StructuralTesting -> AcceptanceTesting -> FaultToleranceTesting -> OperationalTesting;
OperationalTesting -> OrthogonalArrayTesting -> StructuredWalkthroughs -> RecoverabilityTesting;
rankdir = TB;
}
