...
rank = same;
edge[style=invis];
FunctionalTesting -> DomainTesting -> UseCaseTesting -> StaticAnalysis;
StaticAnalysis -> StructurebasedTesting -> PerformanceTesting;
PerformanceTesting -> FaultToleranceTesting -> PathTesting;
rankdir = LR;
}
