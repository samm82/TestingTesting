...
ContinuityTesting [label=<Continuity<br/>Testing>];
...
PerformanceTesting -> PerformanceEfficiencyTesting[dir=none,style="dashed",color="blue"];
...
BackupandRecoveryTesting -> ContinuityTesting[style="dashed",color="blue"];
...
ContinuityTesting -> NonfunctionalTesting[color="blue"];
...
FailoverRecoveryTesting -> ContinuityTesting[style="dashed",color="maroon"];
...
MigrationTesting -> NonfunctionalTesting[color="blue"];
...
RecoveryTesting -> ContinuityTesting[style="dashed",color="blue"];
...
ReliabilityTesting -> StructurebasedTesting[style="dashed",color="blue"];
