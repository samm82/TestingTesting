...
DecisionTesting -> ConditionTesting[dir=none,style="dashed",color="blue"];
...
CorrectnessTesting [label=<Correctness<br/>Testing>,style="dotted"];
CorrectnessTesting -> FunctionalTesting[dir=none,color="blue"];
ConformanceTesting [label=<Conformance<br/>Testing>,style="dotted"];
...
DataFlowTesting -> MutationTesting[style="dashed",color="blue"];
DataFlowTesting -> PathTesting[style="dashed",color="blue"];
...
ForcingExceptionTesting -> NegativeTesting[style="dashed",color="blue"];
...
IntegrationTesting -> FormalTesting[style="dashed",color="maroon"];
...
MonkeyTesting -> FuzzTesting[color="grey"];
...
StatementTesting -> PathTesting[style="dashed",color="blue"];
