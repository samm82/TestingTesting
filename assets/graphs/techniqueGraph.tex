...
ZeroSwitchTesting [label=<0-Switch<br/>Testing>,color=gray];
OneSwitchTesting [label=<1-Switch<br/>Testing>,color=gray];
...
AllRulesTesting [label=<All<br/>Rules<br/>Testing>,color=gray];
AllTransitionsTesting [label=<All<br/>Transitions<br/>Testing>,color=gray];
AllCUsesTesting [label=<All-C-Uses<br/>Testing>];
AllCUsesSomePUsesTesting [label=<All-C-Uses/Some-P-Uses<br/>Testing>,color=gray];
AllDefinitionsTesting [label=<All-Definitions<br/>Testing>];
AllDUPathsTesting [label=<All-DU-Paths<br/>Testing>];
AllInputGUITesting [label=<All-Input-GUI<br/>Testing>,color=gray];
AllPUsesTesting [label=<All-P-Uses<br/>Testing>];
AllPUsesSomeCUsesTesting [label=<All-P-Uses/Some-C-Uses<br/>Testing>,color=gray];
AllURLTesting [label=<All-URL<br/>Testing>,color=gray];
...
BasicBlockTesting [label=<Basic<br/>Block<br/>Testing>,color=gray];
BehaviouralTesting [label=<Behavioural<br/>Testing>,color=gray];
BigBangTesting [label=<Big-Bang<br/>Testing>];
BlockTesting [label=<Block<br/>Testing>,style="dashed",color=gray];
...
BufferOverrunTesting [label=<Buffer<br/>Overrun<br/>Testing>,style="dashed",color=gray];
...
CheckedStatementTesting [label=<Checked<br/>Statement<br/>Testing>,color=gray];
