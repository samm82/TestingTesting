...
BigBangTesting [label=<Big-Bang<br/>Testing>,color=gray];
BottomUpTesting [label=<Bottom-Up<br/>Testing>,color=gray];
BusinessAcceptanceTesting [label=<Business<br/>Acceptance<br/>Testing>];
ClosedBetaTesting [label=<Closed<br/>Beta<br/>Testing>,color=gray];
...
DataCenterTesting [label=<Data<br/>Center<br/>Testing>,color=gray];
DesktopDevelopmentTesting [label=<Desktop<br/>Development<br/>Testing>,style="dashed"];
DevelopmentTesting [label=<Development<br/>Testing>,color=gray];
ExternalLinksIntegrationTesting [label=<External<br/>Links<br/>Integration<br/>Testing>,style="dashed",color=gray];
FactoryAcceptanceTesting [label=<Factory<br/>Acceptance<br/>Testing>];
FollowonOperationalTesting [label=<Follow-on<br/>Operational<br/>Testing>,color=gray];
...
InitialOperationalTesting [label=<Initial<br/>Operational<br/>Testing>,color=gray];
InputDataTesting [label=<Input<br/>Data<br/>Testing>];
InstallationTesting [label=<Installation<br/>Testing>];
IntegratedSystemTesting [label=<Integrated<br/>System<br/>Testing>,color=gray];
...
LegacySystemIntegrationTesting [label=<Legacy<br/>System<br/>Integration<br/>Testing>,style="dashed",color=gray];
MLModelTesting [label=<ML<br/>Model<br/>Testing>];
NeighborhoodIntegrationTesting [label=<Neighborhood<br/>Integration<br/>Testing>,color=gray];
OpenBetaTesting [label=<Open<br/>Beta<br/>Testing>,color=gray];
...
OutsideInTesting [label=<Outside-In<br/>Testing>,color=gray];
PairwiseIntegrationTesting [label=<Pairwise<br/>Integration<br/>Testing>,color=gray];
