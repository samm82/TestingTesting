...
CustomerProductIntegrationTesting [label=<Customer<br/>Product<br/>Integration<br/>Testing>];
...
HumanintheLoopTesting [label=<Human-in-the-Loop<br/>Testing>,color=grey];
...
SystemsTesting [label=<Systems<br/>Testing>];
...
CustomerProductIntegrationTesting -> CustomerAcceptanceTesting[dir=none,color="grey"];
...
SystemsTesting -> SystemTesting[dir=none,style="dashed",color="maroon"];
...
CustomerProductIntegrationTesting -> IntegrationTesting[color="grey"];
...
IntegrationTesting -> SystemsTesting[style="dashed",color="maroon"];
...
QualificationTesting -> AcceptanceTesting[style="dashed",color="grey"];
...
SystemIntegrationTesting -> SoSTesting[style="dashed",color="maroon"];
...
SystemsTesting -> SoSTesting[style="dashed",color="maroon"];
...
UserAcceptanceTesting -> SoSTesting[style="dashed",color="maroon"];
