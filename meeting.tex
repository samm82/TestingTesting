...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{.6\textwidth}
            \begin{figure}
                \centering
                \only{\includegraphics[height=0.5\textheight]{assets/images/first todos}
                    %             \caption{\tiny \citep[Fig.~2]{IEEE2022}}
                }<1>
                \only{\includegraphics[height=0.65\textheight]{assets/images/second todos}
...
\begin{frame}[c]{Relations from \citet{Firesmith2015}?}
    \framesubtitle{Introduction}
    \begin{figure}
        \begin{center}
