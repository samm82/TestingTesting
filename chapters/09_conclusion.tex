...
standardized conventions gives software testers common ground to use or
...
is trivially reflexive. In total, we find \flawCount{} flaws in the software
testing literature, most of which are contradictions. \contraSummary{}
Additionally, \catsSummary*{}

Our work provides a solid baseline for a more thorough standardization of the
