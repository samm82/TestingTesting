...
consideration either in part or in full; \nameref{hard-test} and \nameref{other-vnv}
are completely out of scope, as well as relevant areas of other testing
approaches that are otherwise in scope. \nameref{static-test} can be performed
...
of analysis. \ifnotpaper Finally, some \nameref{derived-tests} were identified;
    of these, \nameref{lang-test} and \nameref{orth-test} are out of
...
\ifnotpaper
    ...
    (\Cref{lang-test}) or other orthogonal test approaches
    (\Cref{orth-test}), but these do not capture new information and are
