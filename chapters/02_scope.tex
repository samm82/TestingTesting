...
\ifnotpaper
    ...
    \ifnotpaper
        ...
        (see \cite[Fig.~1]{SharmaEtAl2021}\thesisissueref{63})\fi. One
    exception to this may be \emph{basic block coverage} since testing all
    ``consecutive parts of code that execute together without any branching''
    \citep[p.~477]{PetersAndPedrycz2000} may border on the infeasible
    exhaustive testing\qtodo{Thoughts?}.
    ...
    \multAuthHelper{include} ``formal reviews'' and ``informal reviews'' in
