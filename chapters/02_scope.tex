...
in scope of this research. In this section, we provide a high-level overview
of what is in scope. We exclude some practices either in full, such as hardware
testing (\Cref{hard-test}), or in part, such as parts of error seeding, fault
...
Additionally, static testing is a useful component of
software testing and is therefore included at this level of analysis, despite
it not being relevant to our original motivation (\Cref{static-test}).
