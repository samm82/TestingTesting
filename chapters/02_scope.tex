...
\ifnotpaper
    ...
    exception to this may be \emph{basic block coverage} since testing every
    ``part of code that executes without any branching'' \citep[Tab.~12.6]{
        PetersAndPedrycz2000} may border on the infeasible exhaustive
    testing\qtodo{Thoughts?}.
