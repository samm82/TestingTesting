...
\ifnotpaper While \acf{orthat}
    ...
    from pre-built and pre-tested hardware components'' \citetext{p.~471}. A subset of
...
\ifnotpaper
    ...
    \seeThesisIssuePar{21}[, \thesisissueref{23}, and \thesisissueref{27}].
    ...
    other languages. These are therefore considered out-of-scope\seeThesisIssuePar{63},
