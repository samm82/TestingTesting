\begin{enumerate}
    ...
    \item % Flaw count (WRONG, LABELS): {IEEE2017} {IEEE2010} | {IEEE2021c} {SWEBOK2025} {SWEBOK2014}
          % Flaw count (WRONG, LABELS): {SWEBOK2025} | {SWEBOK2025} {SWEBOK2014}
          % Flaw count (CONTRA, DEFS): {IEEE2017} {IEEE2010} | {IEEE2021c} | {IEEE2017} | {SWEBOK2025} {SWEBOK2014}
          % Flaw count (CONTRA, DEFS): {SWEBOK2025} | {SWEBOK2025} {SWEBOK2014}
    ...
    \item % Flaw count (OVER, LABELS): {IEEE2010} | {IEEE2010}
          % Flaw count (WRONG, SYNS): implied by {IEEE2010} | implied by {IEEE2010}
          % Assertion: {SWEBOK2025} {vanVliet2000}
    ...
    \item % Flaw count (WRONG, DEFS): {ISO_IEC2014}
    ...
    \item % Flaw count (WRONG, SCOPE): {SWEBOK2025}
          \qualImprovFlaw{}
    ...
    \item % Flaw count (AMBI, DEFS): {IEEE2017} {IEEE2010} {SWEBOK2025} | {SWEBOK2025}
          ...
          \citeyear[p.~128]{IEEE2010}; \citealp[p.~12\=/3]{SWEBOK2025}\footnote{
              \citet[p.~12\=/3]{SWEBOK2025} references the definition given in
              \citep[p.~165]{IEEE2017}; while we would usually omit the former
              in favour of the original source, we include it here as an
    ...
    \item % Flaw count (CONTRA, LABELS): {IEEE2019a} {IEEE2017} {ISO_IEC2005} {SWEBOK2025} | {SWEBOK2025}
          % Assertion: {vanVliet2000}
          ...
          (\citealp[p.~7]{IEEE2019a}; \citeyear[p.~178]{IEEE2017}\todo{OG
              ISO/IEC, 2013}; \citealp{ISO_IEC2005}\todo{OG IEEE, 1990}; similar
          in \citealp[p.~5\=/3]{SWEBOK2025}; \citealp[p.~400]{vanVliet2000})
          that is ``externally visible'' (\citealp[p.~7]{IEEE2019a};
          \citeyear[p.~178]{IEEE2017}\todo{OG ISO/IEC, 2013}; similar in
          \citealp[p.~5\=/3]{SWEBOK2025}; \citealp[p.~400]{vanVliet2000}).
    \item % Flaw count (AMBI, LABELS): {IEEE2017} {IEEE2010} {SWEBOK2025} | {SWEBOK2025}
          % Assertion: {vanVliet2000}
          ...
          ``fault'' have distinct meanings (\citealp[pp.~165\todo{OG 2009},
    ...
    \item % Flaw count (WRONG, SYNS): {IEEE2017} {IEEE2010} {vanVliet2000} | {Patton2006}
          ...
          (\citealp[pp.~124, 165\todo{OG 2009}, 178\==179]{IEEE2017};
