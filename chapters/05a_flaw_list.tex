\begin{enumerate}
    ...
    \item % Flaw count (CONTRA, LABELS): {IEEE2019a} {SWEBOK2025} | {SWEBOK2025}
          % Assertion: {vanVliet2000}
          ...
          ``externally visible'' (\citealp[p.~7]{IEEE2019a}; similar
    ...
    \item % Flaw count (WRONG, SYNS): {IEEE2017} {IEEE2010} {vanVliet2000} | {Patton2006}
          ...
          (\citealp[pp.~124, 165\todo{OG IEEE, 2009}, 178\==179]{IEEE2017};
