\begin{enumerate}
    ...
    \item % Flaw count (WRONG, LABELS): {IEEE2021c} {SWEBOK2025} {SWEBOK2014}
          % Flaw count (CONTRA, DEFS): {IEEE2021c} | {SWEBOK2025} {SWEBOK2014}
          % Assertion: {IEEE2010} {SWEBOK2025} {vanVliet2000}
          % Label error-guess
          \errorGuessFlaw{}
    ...
    \item % Flaw count (OVER, DEFS): {IEEE2010} {SWEBOK2025}
          ...
          \citealp[pp.~17\=/18 to 17\=/19, 18\=/7 to 18\=/8]{SWEBOK2025}).
    ...
    \item % Flaw count (CONTRA, LABELS): {IEEE2019a} {ISO_IEC2005} {SWEBOK2025} | {SWEBOK2025}
          % Assertion: {vanVliet2000}
          ...
          (\citealp[p.~7]{IEEE2019a}; \citealp{ISO_IEC2005}\todo{OG IEEE,
              1990}; similar in \citealp[pp.~5\=/3, 12\=/3]{SWEBOK2025};
          \citealp[p.~400]{vanVliet2000}) that is ``externally visible''
          (\citealp[p.~7]{IEEE2019a}; similar in \citealp[pp.~5\=/3,
              12\=/3]{SWEBOK2025}; \citealp[p.~400]{vanVliet2000}).
    \item % Flaw count (AMBI, LABELS): {SWEBOK2025} | {SWEBOK2025}
          % Assertion: {vanVliet2000}
          ...
          ``fault'' have distinct meanings (\citealp[pp.~5\=/3, 12\=/3]{SWEBOK2025};
    ...
    \item % Flaw count (WRONG, SYNS): {IEEE2010} {SWEBOK2025} {vanVliet2000} | {Patton2006}
          % Label bug-patton
          The differences between the terms ``error'', ``failure'',
          ``fault'', ``defect'' are significant and meaningful
          (\citealp[pp.~128, 139\==140]{IEEE2010}; \citealp[p.~12\=/3]{SWEBOK2025};
