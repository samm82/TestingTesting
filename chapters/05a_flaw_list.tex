\begin{enumerate}
    ...
    \item % Flaw count (CONTRA, SYNS): {IEEE2021c} | implied by {IEEE2021c}
          ...
          to the other is not a direct mapping (p.~4). This is supported by the
          two terms being separated in \citet[Fig.~G.1, Secs.~5.3.2, 5.3.3]
          {IEEE2021c}, but (Fig.~F.1) implies these terms are synonyms,
          contradicting this separation and making decision testing's relations
          ambiguous.
