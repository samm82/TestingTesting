\begin{enumerate}
    \item % Flaw count (CONTRA, PARS): {IEEE2022} {IEEE2021a} {Firesmith2015} | {IEEE2017} {SWEBOK2024} {BarbosaEtAl2006} | {vanVliet2000}
          ...
          approaches \ifnotpaper
              (\citealp[p.~8]{IEEE2022}; \citealp[p.~3]{IEEE2021a};
              \citealp[p.~34]{Firesmith2015})%
          \else
              \cite[p.~8]{IEEE2022}, \cite[p.~3]{IEEE2021a},
              \cite[p.~34]{Firesmith2015}%
    ...
    \item % Flaw count (MISS, DEFS): {IEEE2022} {IEEE2021b}
          Integration testing, system testing, and system integration testing
          are all listed as ``common test levels'' \ifnotpaper
              (\citealp[p.~12]{IEEE2022}; \citeyear[p.~6]{IEEE2021b})%
          \else
              \cite[p.~12]{IEEE2022}, \cite[p.~6]{IEEE2021b}%
    ...
    \item % Flaw count (WRONG, LABELS): {IEEE2021b} {SWEBOK2024} {SWEBOK2014}
          % Flaw count (CONTRA, DEFS): {IEEE2021b} | {SWEBOK2024} {SWEBOK2014}
    ...
    \item % Flaw count (OVER, SYNS): {IEEE2017} {IEEE2013} | {IEEE2022} {IEEE2017} {Perry2006}
          ...
          \ifnotpaper % \cite[pp.~420, 509]{IEEE2017}
              (pp.~420, 509; \citealp[p.~56]{Perry2006})%
          \else
              \citetext{pp.~420, 509}, \cite[p.~56]{Perry2006}%
          \fi.
    \item % Flaw count (OVER, DEFS): {IEEE2010} | {IEEE2010}
          % Assertion: {SWEBOK2024} {vanVliet2000}
          \refHelper \citet[p.~128]{IEEE2010} \multiAuthHelper{define}
          ...
          when a developer makes an error \ifnotpaper
              % \citeyear[pp.~128, 140]{IEEE2010}
              (pp.~128, 140; \citealp[p.~12\=/3]{SWEBOK2024};
              \citealp[pp.~399\==400]{vanVliet2000})\else
              \citetext{pp.~128, 140}, \cite[pp.~399\==400]{vanVliet2000},
              \cite[p.~12\=/3]{SWEBOK2024}\fi, this means that they are
    ...
    \item % Flaw count (CONTRA, DEFS): {IEEE2021b} {IEEE2017} | {vanVliet2000} implied by {IEEE2021b}
          % Label c-use-def
          % TODO: SUPP DEFS?
    ...
    \item % Flaw count (CONTRA, DEFS): {IEEE2021b} | {IEEE2017}
          % TODO: SUPP DEFS?
    ...
    \item % Flaw count (WRONG, LABELS): {IEEE2021b}
          A typo in \citep[Fig.~2]{IEEE2021b} means that ``specification-based
    ...
    \item % Flaw count (CONTRA, DEFS): {IEEE2017} | {IEEE2021b}
          % Assertion: {IEEE2021b} {vanVliet2000} {PetersAndPedrycz2000}
          \citet[p.~83\todo{OG 2015}]{IEEE2017}'s definition of
          ...
          (\citeyear[p.~27]{IEEE2021b}; similar in \citealp[p.~425]{vanVliet2000};
    ...
    \item % Flaw count (AMBI, DEFS): {IEEE2016} {IEEE2017} {IEEE2012} {vanVliet2000}
          ...
          assigned a value'' (\citealp[p.~3]{IEEE2021b}; \citeyear[p.~115]{IEEE2017}%
    ...
    \item % Flaw count (CONTRA, SYNS): implied by {IEEE2016} | {IEEE2022} {IEEE2016}
          ...
          % STD | META
    \item % Flaw count (WRONG, CATS): {IEEE2022} {IEEE2021b} {IEEE2017} | ISTQB
    ...
    \item % Flaw count (CONTRA, SYNS): ISTQB | {IEEE2022}
          ...
          % IEEE2021b omitted to avoid double-counting in parSyns table
          ...
          testing'' in \citeyearpar[p.~20]{IEEE2021b}\todo{OG Hass, 2008}.
    ...
    \item % Flaw count (WRONG, SCOPE): {SWEBOK2024}
          \refHelper \citet[p.~5\=/4]{SWEBOK2024} says that quality improvement,
    ...
    \item % Flaw count (WRONG, TRACE): {SWEBOK2024}
          % Label elas-ref
          \refHelper \citet[p.~5\=/9]{SWEBOK2024}'s definition of
    ...
    \item % Flaw count (CONTRA, DEFS): {IEEE2022} | {Patton2006}
          % Label load-def
          \loadFlaw{}
    \item % Flaw count (CONTRA, DEFS): {IEEE2021b} | {Patton2006}
          State testing requires that ``all states in the state model
          \dots\ [are] `visited'\,'' \citep[p.~19]{IEEE2021b}, but
    ...
    \item % Flaw count (CONTRA, LABELS): {IEEE2021b} {IEEE2017} {PetersAndPedrycz2000} | {vanVliet2000}
          % TODO: SUPP LABELS?
    ...
    \item % Flaw count (CONTRA, LABELS): {IEEE2021b} {PetersAndPedrycz2000} | {vanVliet2000}
          % TODO: SUPP LABELS?
    ...
    \item % Flaw count (MISS, DEFS): {IEEE2021b} {IEEE2017} {PetersAndPedrycz2000} implied by {vanVliet2000} | {vanVliet2000}
    ...
    \item % Flaw count (CONTRA, DEFS): {vanVliet2000} | {IEEE2021b} {IEEE2017} {PetersAndPedrycz2000}
          \refHelper \Citet[pp.~424-425]{vanVliet2000} specifies that every
    ...
    \item % Flaw count (CONTRA, DEFS): {vanVliet2000} | {IEEE2021b} {IEEE2017} {SWEBOK2024} {PetersAndPedrycz2000}
    ...
    \item % Flaw count (CONTRA, DEFS): {vanVliet2000} | {IEEE2021b}
          \refHelper \Citet[pp.~432\==433]{vanVliet2000} says that
          all-\acsp{p-use} testing is only stronger than all-edges (branch)
          testing if there are infeasible paths, but
          \citet[Fig.~F.1\todo{OG Reid, 1996}]{IEEE2021b} \ifnotpaper do
    ...
    \item % Flaw count (WRONG, PARS): {IEEE2021b} {IEEE2017} {vanVliet2000} | implied by {PetersAndPedrycz2000}
          ...
          (\citealp[pp.~5, 27]{IEEE2021b}; \citeyear[p.~332\todo{OG 2015}]{IEEE2017};
          \citealp[p.~424]{vanVliet2000}), and only the \acs{p-use} relation is
          implied by \citet[Fig.~F.1\todo{OG Reid 1996}]{IEEE2021b}.
    ...
    \item % Flaw count (WRONG, TRACE): {Kam2008}
          ...
          \seeRefMissing{}
    \item % Flaw count (CONTRA, CATS): {Kam2008} | implied by {IEEE2021b}
          ...
          test approach or test design technique''; while \citet{IEEE2021b}
    ...
    \item % Flaw count (AMBI, CATS): {IEEE2022} {IEEE2021b} {IEEE2017} {SWEBOK2024} ISTQB {KuļešovsEtAl2013} {Perry2006} {PetersAndPedrycz2000} {Gerrard2000a} | {BarbosaEtAl2006}
          % Flaw count (AMBI, CATS): {IEEE2022} | {IEEE2022} {IEEE2021b} {IEEE2017}
    ...
    \item % Flaw count (WRONG, SYNS): {IEEE2017} {SakamotoEtAl2013} | {SneedAndGöschl2000}
          ...
          this mapping is incorrect; for example, \citet[p.~444]{IEEE2017}
          \multiAuthHelper{say} ``structure-based [(or white-box)] testing is
          not restricted to use at component level and can be used at all
          levels'' and \citet[pp.~345--346]{SakamotoEtAl2013}
          \multiAuthHelper{describe} ``black-box integration testing''%
          \todo{more examples?}.
