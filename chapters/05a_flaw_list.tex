\begin{enumerate}
    ...
    \item % Flaw count (CONTRA, DEFS): {IEEE2017} | {IEEE2021}
          % Assertion: {IEEE2021} {vanVliet2000} {PetersAndPedrycz2000}
          ...
          (\citeyear[p.~27]{IEEE2021}; similar in \citealp[p.~425]{vanVliet2000};
    ...
    \item % Flaw count (CONTRA, LABELS): {IEEE2021} {IEEE2017} {PetersAndPedrycz2000} | {vanVliet2000}
          ...
          and ``\acs{p-use}'' (\citealp[pp.~3, 27\==29, 35\==36, 114\==155,
              117\==118, 129]{IEEE2021}; \citeyear[p.~124]{IEEE2017};
    ...
    \item % Flaw count (CONTRA, DEFS): {vanVliet2000} | {IEEE2021} {IEEE2017} {PetersAndPedrycz2000}
          ...
          (\citealp[pp.~28\==29]{IEEE2021}; \citeyear[p.~120]{IEEE2017};
    ...
    \item % Flaw count (CONTRA, DEFS): {vanVliet2000} | {IEEE2021}
          ...
          \citet[Fig.~F.1\todo{OG Reid, 1996}]{IEEE2021} \ifnotpaper do
    ...
    \item % Flaw count (WRONG, PARS): {IEEE2021} {IEEE2017} {vanVliet2000} | implied by {PetersAndPedrycz2000}
          ...
          (\citealp[pp.~5, 27]{IEEE2021}; \citeyear[p.~332\todo{OG 2015}]{IEEE2017};
          \citealp[p.~424]{vanVliet2000}), and only the \acs{p-use} relation is
          implied by \citet[Fig.~F.1\todo{OG Reid 1996}]{IEEE2021}.
    ...
    \item % Flaw count (AMBI, CATS): {IEEE2022} {IEEE2021} {IEEE2017} {SWEBOK2024} ISTQB {KuļešovsEtAl2013} {Perry2006} {PetersAndPedrycz2000} {Gerrard2000a} | {BarbosaEtAl2006}
          % Flaw count (AMBI, CATS): {IEEE2022} | {IEEE2022} {IEEE2021} {IEEE2017}
