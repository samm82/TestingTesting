\begin{enumerate}
    ...
    \item % Flaw count (CONTRA, DEFS): {IEEE2017} | {SWEBOK2025} | ISTQB
          % Label alpha-def
          \alphaFlaw{} These differences make it unclear how testers should
          perform alpha testing, which could lead to miscommunication and
          unmet expectations.
    ...
    \item % Flaw count (WRONG, TRACE): ISTQB
          The source that \citetISTQB{} cite for the definition of ``security
          attack'' does not provide a definition.\imptodo{Verify!}
    \item % Flaw count (WRONG, TRACE): ISTQB
          The source that \citetISTQB{} cite for the definition of ``visual
          testing'' does not provide a definition.\imptodo{Verify!}
    \item % Flaw count (WRONG, TRACE): ISTQB
