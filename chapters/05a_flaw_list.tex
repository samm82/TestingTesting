\begin{enumerate}
    ...
    \item % Flaw count (MISS, DEFS): {IEEE2022} {IEEE2021c}
          ...
          \citeyear[p.~6]{IEEE2021c}), but the latter two are not defined.
    ...
    \item % Flaw count (AMBI, DEFS): {IEEE2016} {IEEE2017} {IEEE2012} {vanVliet2000}
          ...
          assigned a value'' (\citealp[p.~3]{IEEE2021c}; \citeyear[p.~115]{IEEE2017}%
    ...
    \item % Flaw count (CONTRA, SYNS): ISTQB | {IEEE2022}
          ...
          % IEEE2021c omitted to avoid double-counting in parSyns table
          ...
          testing'' in \citeyearpar[p.~20]{IEEE2021c}\todo{OG Hass, 2008}.
    ...
    \item % Flaw count (WRONG, PARS): {IEEE2021c} {IEEE2017} {vanVliet2000} | implied by {PetersAndPedrycz2000}
          ...
          (\citealp[pp.~5, 27]{IEEE2021c}; \citeyear[p.~332\todo{OG 2015}]{IEEE2017};
    ...
    \item % Flaw count (AMBI, CATS): {IEEE2022} {IEEE2021c} {IEEE2017} {SWEBOK2024} ISTQB {KuļešovsEtAl2013} {Perry2006} {PetersAndPedrycz2000} {Gerrard2000a} | {BarbosaEtAl2006}
          % Flaw count (AMBI, CATS): {IEEE2022} {IEEE2021a} {IEEE2021b} | {IEEE2022} {IEEE2021c} {IEEE2017}
          ...
          clearly detailed why. They are also implied be separate from test
          levels, test types, \emph{and} test techniques
          (\citeyear[p.~8]{IEEE2021a}; \citeyear[p.~4]{IEEE2021b}), which by
          process of elimination based on our assumption that categories are
          orthogonal (see \Cref{orth-approach}) might make them test practices.
          \citet[p.~3]{BarbosaEtAl2006} consider regression testing to be a
          test level, but since it is not included as an example of a test
          level by the sources that describe them (see \Cref{cats-def}), this
          categorization is is likely not universal at best and incorrect at worst.
