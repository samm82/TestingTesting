\begin{enumerate}
    ...
    \item % Flaw count (MISS, SYNS): {IEEE2017} implied by {IEEE2021c} {IEEE2017} | {IEEE2022} {IEEE2021c} ISTQB
          ...
          transitive synonym relationship (see \Cref{syn-rels}) to
    ...
    \item % Flaw count (CONTRA, DEFS): {SWEBOK2024} | {IEEE2017}
          ...
          \todo{OG PMBOK 5th ed.}: testing that evaluates the degree to which
