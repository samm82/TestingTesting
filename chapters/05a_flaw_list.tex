\begin{enumerate}
    ...
    \item % Flaw count (MISS, DEFS): {IEEE2022} {IEEE2021b}
          ...
          are all listed as ``common test levels'' (\citealp[p.~12]{IEEE2022};
          \citeyear[p.~6]{IEEE2021b}), but the latter two are not defined.
    ...
    \item % Flaw count (CONTRA, CATS): {Kam2008} | implied by {IEEE2021b}
          ...
          or test design technique''; while \citet{IEEE2021b} seem to support
