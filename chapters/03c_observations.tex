...
\fi
some terminology (see \refIEEETestTerms{}). However,
\ifnotpaper
    other sources \citep{BarbosaEtAl2006, SouzaEtAl2017}
\else
    \cite{BarbosaEtAl2006, SouzaEtAl2017}
\fi provide alternate
    ...
    \item The following are test approaches that are categorized as test
          ...
          \begin{enumerate}
              ...
              \item Performance testing
                    ...
                    \else
                        \cite[pp.~7,~22,~26-27]{IEEE2022},
                        \cite[p.~7]{IEEE2021}, implied by
                        \cite[p.~53]{Firesmith2015}
                    \fi
              \item Stress testing
                    \ifnotpaper
                    ...
                    \else
                        \cite[pp.~9,~22]{IEEE2022},
                        \cite[p.~442]{IEEE2017}, implied by
                        \cite[p.~54]{Firesmith2015}
                    \fi
          \end{enumerate}
