...
% \texttt{build/stdSmntcDiscBrkdwn.tex}. These data
, then read them in to macros
% (such as \macro{stdSmntcDiscBrkdwn})
to populate \Cref{tab:sntxDiscreps,tab:smntcDiscreps}. For example,
\macro[1]{stdSntxDiscBrkdwn} corresponds to the number of explicit mistakes in
standards documents, and \macro[2]{stdSntxDiscBrkdwn} to the number of implicit
ones. These macros also include \macro[13]{totalSntxDiscBrkdwn} and \newline
\macro[13]{totalSntxDiscBrkdwn}, which are identical and
