...
as described in \Cref{record-flaws} we detect automatically before generating
...
\Cref{record-flaws}. We manually create these flaw comments when recording
flaws from the literature manually (\Cref{record-info}) and generate them when
automatically detecting flaws from \ourApproachGlossary{} (\Cref{auto-flaw-analysis}).
