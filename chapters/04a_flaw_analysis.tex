...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \draw (-\spread, 0) coordinate (a) circle (\radius);
        \draw ( \spread, 0) coordinate (b) circle (\radius);
        \draw (0, -\offset) coordinate (c) circle (\radius);
        ...
        % ALL
        \node[above] at (0, -\spread-0.5) {\parbox[t]{3.7cm}{\centering
                \citealp{IEEE2010,IEEE2013,IEEE2016,IEEE2017,IEEE2019,
                    IEEE2021,IEEE2022}}};
        % ISO/IEC
        \node[above] at (0, 0.325*\radius) {\parbox[t]{2.8cm}{\centering
                \citealp{ISO_IEC2011,ISO_IEC2015,ISO_IEC2018,ISO_IEC2023a,ISO_IEC2023b}}};
        % IEEE
        \node[above] at (0, -\spread-1.4*\radius) {\citealp{IEEE2012}};

        % \node (a) {\citealp{ISO2015,ISO2022}};
        % \node (b) {---};
        % \node (c) {\citealp{IEEE2012}};
    \end{tikzpicture}
