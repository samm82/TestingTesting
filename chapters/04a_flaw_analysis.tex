...
\begin{figure}[bt!]
    ...
    \begin{tikzpicture}
        ...
        \node[above] at (0, -\spread-0.5) {\parbox{3.6cm}{\centering
                \citealp{IEEE2022,IEEE2021a,IEEE2021b,IEEE2019a,IEEE2019b,
                    IEEE2017,IEEE2016,IEEE2013,IEEE2010}}};
        % ISO/IEC
...
is the label used for a test approach node in these visualizations. This process
...
\begin{displayquote}
    \texttt{\% Flaw count (CONTRA, DEFS): \{IEEE2021b\} \{IEEE2017\} |
        \displayNL \{vanVliet2000\} implied by \{IEEE2021b\}}
\end{displayquote}
