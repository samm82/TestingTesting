...
``explicit'' a piece of information is (see \Cref{explicitness}). This is useful when
...
counted only for its most ``explicit'' manifestation (i.e., it will only increment
...
equivalent explicit flaw, as we do when generating graphs (\Cref{graphExplicit}).
\begin{displayquote}
