...
``trusted'' tier\footnote{If an inconsistency occurs between two source tiers
    and the more trustworthy one is \emph{incorrect}, we instead count it as an
    inconsistency between it and ground truth, as described in
    \Cref{lower-ground-truth}.} (see \Cref{trust,sources}). This avoids
