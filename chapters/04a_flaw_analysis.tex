...
\begin{figure}[bt!]
    ...
    \begin{tikzpicture}
        ...
        % ISO/IEC
        \node[above] at (0, 0.325*\radius) {\parbox{3cm}{\centering
                \citealp{ISO_IEC2023a,ISO_IEC2023b,ISO_IEC2018,ISO_IEC2015,
                    ISO_IEC2014,ISO_IEC2011}}};
        % ISO/IEEE
...
\Cref{record-flaws}. We include these flaw comments when manually recording
flaws from the literature (\Cref{record-info}) and generate them when
