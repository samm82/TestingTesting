...
though the literature does not use these terms. These classifications
...
\ifnotpaper\else \citeauthor{IEEE2022} \fi \citet{IEEE2022} due to its wide usage.
...
These categories are loosely described by what they specify
...
\Cref{tab:flawMnfsts,tab:flawDmns}, respectively. We also introduce some terms
