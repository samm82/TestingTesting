...
\ifnotpaper Additionally, \Cref{tab:parSyns,tab:multiCats,tab:infMultiCats}
    ...
    such. Although these data originate from our judgement,
    we document them for completeness; we give inferred flaws in
    \Cref{infer-flaws} and any inferred relations in \recFigs{}.
\fi
