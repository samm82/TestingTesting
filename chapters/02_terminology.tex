...
subjective) by defining the notion of ``explicitness'' (\Cref{explicitness}) and
...
However, these relations can also be less ``explicit'' (see \Cref{explicitness});
...
keywords given above\qtodo{Is this enough to satisfy Dr.~Smith's concern about
    the explicitness of Synonym Relation sources?}. The following non-mutually
