...
``artifact''\thesisissuenote{44,119,39} since some terms can refer to both the
...
\ifnotpaper
    ...
    \citep[p.~93]{IEEE2017}, but often are not.
...
will likely be excluded during later analysis\thesisissuenote{52}.
