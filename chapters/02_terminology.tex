...
evaluation is made of some aspect of the system or component'' \ifnotpaper
    (\citealp[p.~10]{IEEE2022}; \citeyear[p.~6]{IEEE2021c};
    \citeyear[p.~473]{IEEE2017}), usually ``with the intent of finding errors''
    (\citealp{Myers1976}, as cited in \citealp[p.~438]{PetersAndPedrycz2000}%
    \footnote{See \flawref{myers-citation}.})\else \cite[p.~473]{IEEE2017},
