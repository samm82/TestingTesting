...
for clarity.\qtodo{Is this OK?} Any kind of information can be implicit,
...
\ifnotpaper Additionally, \Cref{tab:parSyns,tab:multiCats,tab:infMultiCats}
    ...
    we document them for completeness. Additionally, all data in our
    glossaries with no source attached are inferred, such as algebraic testing
    \citep[Fig.~12.2]{PetersAndPedrycz2000} being a child of mathematical-based
    testing. We present inferred flaws in \Cref{infer-flaws} and colour
    inferred approaches and relations grey in our generated graphs, such as
    \recFigs{}.
\fi
