...
the results of step~\ref{step:cmp-results} \ifnotpaper (\citealp[p.~10]{IEEE2022};
    ...
    \cite[p.~465]{IEEE2017}, \cite[p.~10]{IEEE2022}, \cite[p.~6]{IEEE2021c}\fi.
...
for hierarchies of approaches given in the literature \ifnotpaper
    ...
    \cite[Fig.~2]{IEEE2022}, \cite[Fig.~2]{IEEE2021c}\fi%; see the graph of
...
hierarchies \ifnotpaper (\citealp[Fig.~F.1]{IEEE2021c};
    ...
    \citetext{Fig.~13.17}, \cite[Fig.~F.1]{IEEE2021c}\fi%; see the graph of
...
\phantomsection{}\label{autoDmnFlaws}
\begin{itemize}
    \item \multiCatIntro*{}
    \item Synonyms that violate transitivity (see \Cref{syn-rels}); if two
