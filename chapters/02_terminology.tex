...
the results of step~\ref{step:cmp-results} \ifnotpaper (\citealp[p.~10]{IEEE2022};
    \citeyear[p.~6]{IEEE2021b};
    \citeyear[p.~465]{IEEE2017}\todo{OG ISO/IEC 2014})\else
    \cite[p.~465]{IEEE2017}, \cite[p.~10]{IEEE2022}, \cite[p.~6]{IEEE2021b}\fi.
...
several test levels'' \ifnotpaper (\citealp[p.~15]{IEEE2022};
    \citeyear[p.~8]{IEEE2021a}; \citeyear[p.~7]{IEEE2021b})\else
    \cite[p.~15]{IEEE2022}, \cite[p.~7]{IEEE2021b}, \cite[p.~8]{IEEE2021a}\fi.
...
test approaches from different categories\ifnotpaper
    ...
    %     \citeyear[pp.~7, 40, Tab.~A.1]{IEEE2021b}; implied by its quality;
    %     \citealp[p.~53]{Firesmith2015})\else \cite[pp.~22, 26--27]{IEEE2022},
    %     \cite[pp.~7, 40, Tab.~A.1]{IEEE2021b}\fi, and scripted testing, a test
...
%     (\citealp[p.~2]{IEEE2022}; \citeyear[p.~1]{IEEE2021b}; similar on p.~12;
%     \citealpISTQB{})%
% \else
%     \cite[p.~2]{IEEE2022}, \cite[p.~1]{IEEE2021b}%
...
%     in \citeyear[p.~6]{IEEE2021b}; \citealp[p.~344]{SakamotoEtAl2013})\else
...
\ifnotpaper
    (\citealp[p.~9]{IEEE2022}; \citeyear[p.~8]{IEEE2021b};
    ...
    \cite[p.~9]{IEEE2022}, \cite{ISTQB}, \cite[p.~8]{IEEE2021b},
...
%         \citep[Fig.~2]{IEEE2021b} and \citep[pp.~5\=/11 to 5\=/12]{SWEBOK2024}%
%     \else
%         \cite[pp.~5\=/11 to 5\=/12]{SWEBOK2024} and \cite[Fig.~2]{IEEE2021b}%
%     \fi, making it a ``grandchild'' of specification-based testing according to
%     these sources.
% } of specification-based testing \ifnotpaper
%     (\citealp{IEEE2022}; \citeyear[Fig.~2]{IEEE2021b}; \citealpISTQB{})\else
%     \cite{IEEE2022,ISTQB}, \cite[Fig.~2]{IEEE2021b}\fi; even V4 agrees with
...
for hierarchies of approaches given in the literature \ifnotpaper
    (\citealp[Fig.~2]{IEEE2022}; \citeyear[Fig.~2]{IEEE2021b};
    \citealp{Firesmith2015})\else \cite{Firesmith2015},
    \cite[Fig.~2]{IEEE2022}, \cite[Fig.~2]{IEEE2021b}\fi%; see the graph of
...
hierarchies \ifnotpaper (\citealp[Fig.~F.1]{IEEE2021b};
    \citealp[Fig.~13.17]{vanVliet2000})\else
    \citetext{Fig.~13.17}, \cite[Fig.~F.1]{IEEE2021b}\fi%; see the graph of
...
%               (\citealp[Fig.~2]{IEEE2022}; \citeyear[Fig.~2]{IEEE2021b};
%               \citealp{Firesmith2015})\else \cite{Firesmith2015},
%               \cite[Fig.~2]{IEEE2022}, \cite[Fig.~2]{IEEE2021b}\fi; we graph
...
%           represented as hierarchies \ifnotpaper (\citealp[Fig.~F.1]{IEEE2021b};
%               \citealp[Fig.~13.17]{vanVliet2000})\else
%               \citetext{Fig.~13.17}, \cite[Fig.~F.1]{IEEE2021b}\fi; we graph the
...
%               (\citealp[Fig.~2]{IEEE2022}; \citeyear[Fig.~2]{IEEE2021b};
%               \citealp{Firesmith2015})\else \cite{Firesmith2015},
%               \cite[Fig.~2]{IEEE2022}, \cite[Fig.~2]{IEEE2021b}\fi, these are
%           likely incomplete. As an example, we graph the parent-child relations
%           from \ifnotpaper (\citealp[Fig.~2]{IEEE2022}; \citeyear[Fig.~2]{IEEE2021b})
%           \else \cite[Fig.~2]{IEEE2022}, \cite[Fig.~2]{IEEE2021b} \fi in the
...
%           relations from \ifnotpaper (\citealp[Fig.~F.1]{IEEE2021b};
%               \citealp[Fig.~13.17]{vanVliet2000}) \else
%               \citetext{Fig.~13.17}, \cite[Fig.~F.1]{IEEE2021b}
