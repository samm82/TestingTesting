...
\Cref{tab:flawMnfsts,tab:flawDmns}, since additional context may rectify
...
\ifnotpaper\afterpage{\begin{landscape}%
    ...
    We give these categorizations in \Cref{tab:otherCategorizations} for
    ...
    source(s) in this column indicates that we inferred the category or that
    not all of the example approaches were categorized by the
    literature; we provide additional context in footnotes when applicable.
