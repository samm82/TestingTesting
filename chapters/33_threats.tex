...
we make some decisions with which others may disagree. The
benefit of our work being open-source means that others can make their own
decisions, modify our data/code appropriately, and observe how this changes
...
\begin{itemize}
    ...
    \item \textbf{Similar Approach Categories:} While our categorization in
          ...
          ours.
    \item \textbf{Alternate Approach Categories:} Similarly, we find many other
