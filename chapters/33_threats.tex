...
\begin{itemize}
    ...
    \item \phantomsection{}\label{qual-test}
          ...
          \citeyear[p.~473]{IEEE2017}\todo{OG IEEE, 2013}), we posit that
          they can be derived from software qualities: ``capabilit[ies] of
          software product[s] to satisfy stated and implied needs when used
          under specified conditions'' \citetext{p.~424}%\citep[p.~424]{IEEE2017}
          \todo{OG ISO/IEC, 2014}. We track \qualityCount{} software qualities%
          \thesisissueref{21,23,27} %in addition to test approaches
