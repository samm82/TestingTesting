...
\citet[pp.~153\==154]{RunesonAndHöst2009}'s definitions of threats to validity
...
\begin{enumerate}
    ...
    \item \textbf{Internal Validity:} ``When \dots{} investigating whether one
          ...
          investigated factor''. (\Cref{inter-valid})
