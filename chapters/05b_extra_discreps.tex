\begin{enumerate}
    ...
    \item % Discrep count (DEFS, AMBI): {IEEE2016} {IEEE2017} {IEEE2012} {vanVliet2000}
          ...
          imprecise.
    \item % Discrep count (CATS, CONTRA): implied by {IEEE2022}
    ...
    \item % Discrep count (SYNS, CONTRA): implied by {IEEE2016} | {IEEE2022} {IEEE2016}
          ...
          % STD | META
    \item % Discrep count (DEFS, AMBI): {SWEBOK2024}
          % {vanVliet2000} not included as part of this discrepancy since it
    ...
    \item % Discrep count (TERMS, AMBI): {SWEBOK2024}
          % {vanVliet2000} not included as part of this discrepancy since it
          % is used as the ground truth
    ...
    \item % Discrep count (TERMS, REDUN): {SWEBOK2024}
          % {Gerrard2000b} not included as part of this discrepancy since it
          % is used as the ground truth
    ...
    \item % Discrep count (PARS, WRONG): {PetersAndPedrycz2000}
          % Ground truth: implied by {IEEE2021}
    ...
    \item % Discrep count (CATS, OVER): {Gerrard2000a}
          ...
          \todo{This discrepancy is based on the static/dynamic categories;
    ...
    \item % Discrep count (SYNS, WRONG): {Kam2008}
          % Ground truth: {SWEBOK2024} {vanVliet2000}
