\begin{enumerate}
    ...
    \item % Discrep count (DEFS, WRONG): {IEEE2017} | {IEEE2017}
          % TODO: SUPP DEFS?
    ...
    \item % Discrep count (CATS, WRONG): {IEEE2016} | {IEEE2016}
    ...
    \item % Discrep count (DEFS, AMBI): {IEEE2016} {IEEE2017} {IEEE2012} {vanVliet2000}
          ...
          imprecise.
    \item % Discrep count (CATS, CONTRA): {IEEE2022} | implied by {IEEE2022}
    ...
    \item % Discrep count (SYNS, CONTRA): implied by {IEEE2016} | {IEEE2022} {IEEE2016}
          ...
          % STD | META
    \item % Discrep count (DEFS, AMBI): {SWEBOK2024} | {SWEBOK2024}
    ...
    \item % Discrep count (TERMS, AMBI): {IEEE2019} {IEEE2010} | {SWEBOK2024}
          % Ground truth: {vanVliet2000}
    ...
    \item % Discrep count (TERMS, AMBI): {SWEBOK2024} | {SWEBOK2024}
          % Ground truth: {vanVliet2000}
          ...
          errors or faults.
    \item % Discrep count (TERMS, REDUN): {SWEBOK2024}
    ...
    \item % Discrep count (TERMS, WRONG): ISTQB
          ...
          specific example mentioned in \discrepref{specific-istqb} and does
    ...
    \item % Discrep count (DEFS, AMBI): {Firesmith2015} | {Firesmith2015}
    ...
    \item % Discrep count (TERMS, OVER): {Firesmith2015} | {Firesmith2015}
          % Label OVER cat-acro
    ...
    \item % Discrep count (DEFS, MISS): {IEEE2021} {IEEE2017} {PetersAndPedrycz2000} | {vanVliet2000}
    ...
    \item % Discrep count (PARS, WRONG): implied by {IEEE2021} | {PetersAndPedrycz2000}
    ...
    \item % Discrep count (SYNS, WRONG): implied by {SharmaEtAl2021}
    ...
    \item % Discrep count (CATS, OVER): {Gerrard2000a} | {Gerrard2000a}
    ...
    \item % Discrep count (DEFS, MISS): {Gerrard2000a}
          ...
          explain them.
    \item % Discrep count (DEFS, MISS): {Gerrard2000a} | {Gerrard2000a}
    ...
    \item % Discrep count (SYNS, WRONG): {SakamotoEtAl2013} | {SneedAndGöschl2000}
    ...
    \item % Discrep count (SYNS, WRONG): {SWEBOK2024} {vanVliet2000} | {Kam2008}
    ...
    \item % Discrep count (SYNS, AMBI): {Kam2008} | implied by {Kam2008}
