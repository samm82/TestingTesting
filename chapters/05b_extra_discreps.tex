    ...
    \item % Discrep count (DEFS, AMBI): {SWEBOK2024}
          ...
          to software itself \citeyearpar[pp.~4\=/9, 6\=/5, 7\=/3, 12\=/4,
              ...
              runtime errors, and logical errors'' \citep[p.~16\=/13, cf.
                  p.~18\=/13]{SWEBOK2024} and numerical errors (in the context
              of accuracy and precision) \citetext{pp.~17\=/18 to 17\=/19,
                  18\=/7 to 18\=/8} since they seem to be in different domains.
              Does that make sense? How should I document this?}
    \item % Discrep count (TERMS, AMBI): {SWEBOK2024}
          % {vanVliet2000} not included as part of this discrepancy since it
          % is used as the ground truth
          \refHelper{} \citet[p.~4\=/11]{SWEBOK2024} says ``fault tolerance is
