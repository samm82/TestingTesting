...
%% Move the definition of the figure to a bit above (in the file) where
% you first reference the figure, so that latex will place it closer to
% its use.
\begin{figure}[hbtp!]
      \centering
      ...
      \begin{minipage}{.425\linewidth}
            ...
            \caption{Proposed
                  relations between rationalized ``recovery testing'' terms.}
...
the relations shown in Figure~\ref{fig:perf-graph}.

\begin{paperFigure}
      \centering
      \performanceGraph{}
      \caption{The proposed relations between ``performance-related testing'' terms.}
