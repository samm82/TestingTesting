\begin{enumerate}
    ...
    \item % Discrep count: {IEEE2017} | {Firesmith2015} | {Firesmith2015} {Gerrard2000a}
    ...
    \item % Discrep count: {SWEBOK2024} implied by {Valcheva2013} {YuEtAl2011} | {Firesmith2015}
    ...
    \item % Discrep count: {Firesmith2015} | {Firesmith2015} {PreußeEtAl2012}
          The same is true for ``hardware-'' and ``human-in-the-loop testing''
          (``HIL'') \citep[p.~23]{Firesmith2015}, although \citet[p.~2]
          {PreußeEtAl2012} \multAuthHelper{use} ``HiL'' for the former.
