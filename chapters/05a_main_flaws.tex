\begin{enumerate}
    ...
    \item % Flaw count (WRONG, PARS): {SWEBOK2024}
          % TODO: Is this a parent flaw?
    ...
    \item % Flaw count (CONTRA, SYNS): ISTQB | {PetersAndPedrycz2000}
          ...
          % \item % Fl  aw count (CONTRA, PARS): {PetersAndPedrycz2000} | {PetersAndPedrycz2000}
