\begin{enumerate}
    \item % Flaw count (PARS, CONTRA): {IEEE2022} {Firesmith2015} | {IEEE2017} {SWEBOK2024} {BarbosaEtAl2006} | {vanVliet2000}
          ...
          of the above misconception. This discrepancy creates a cyclic
    ...
    \item % Flaw count (SYNS, CONTRA): ISTQB | {IEEE2022}
          ...
          % IEEE2021 omitted from this discrepancy to avoid
          % double-counting in parSyns table
    ...
    \item % Flaw count (SYNS, CONTRA): ISTQB implied by {Gerrard2000a} | {SWEBOK2024}
          ...
          ``test levels'' (see \Cref{categories-observ}).
