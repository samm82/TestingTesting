\begin{enumerate}
    ...
    \item % Flaw count (LABELS, WRONG): {IEEE2021} {SWEBOK2024} {SWEBOK2014}
    ...
    \item % Flaw count (LABELS, WRONG): {IEEE2017} {Firesmith2015} {vanVliet2000}
    ...
    \item % Flaw count (LABELS, AMBI): {IEEE2017} | {Firesmith2015} | {Firesmith2015} {Gerrard2000a}
    ...
    \item % Flaw count (LABELS, WRONG): {Firesmith2015}
          % Ground truth: {LiuEtAl2023} {MorgunEtAl1999} {HolleyEtAl1996} {HoweAndJohnson1995}
          % Label LABELS ground-truth
          \tolTestFlaw{}
    \item % Flaw count (LABELS, OVER): {SWEBOK2024} implied by {Valcheva2013} {YuEtAl2011} | {Firesmith2015}
          ...
          % META | TEXT
    \item % Flaw count (LABELS, AMBI): {IEEE2022} {IEEE2021} {IEEE2017} {SWEBOK2024} ISTQB {KuļešovsEtAl2013} {Perry2006} {PetersAndPedrycz2000} {Gerrard2000a} | {vanVliet2000} implied by {SWEBOK2024}
    ...
    \item % Flaw count (TRACE, WRONG): {Kam2008}
          % Flaw count (DEFS, MISS): {Kam2008}
