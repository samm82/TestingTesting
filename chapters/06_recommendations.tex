...
\citetext{p.~93:14}! However, these terms are distinct in the context of
definitions provided by \citet{SWEBOK2024} \ifnotpaper who \else which \fi
cites \citet{BertolinoEtAl2019}:
\begin{itemize}
    \item \textbf{Scalability:} ``the software's ability to increase and
          ...
          transactions, and volume of data'' \citep[p.~5\=/5; similar on
              p.~5\=/9]{SWEBOK2024}.
