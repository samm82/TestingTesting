...
provide graphical representations (see \Cref{\ifnotpaper graph-gen\else tools\fi})
...
\Cref{sources}) that defines them. We color all proposed approaches and
relations orange. \ifnotpaper We also include inferred approaches and relations
    in grey for completeness\todo{Should this be the case?}, although they are
    not explicitly defined in the literature (see \Cref{infers}).
