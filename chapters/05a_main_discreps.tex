\begin{enumerate}
    ...
    \item % Discrep count (DEFS, CONTRA): {IEEE2017} | {SWEBOK2024} | ISTQB
          \alphaDiscrep{}
    \item % Discrep count (SYNS, CONTRA): ISTQB {Kam2008} | {IEEE2022}
          ...
          by \citetISTQB{} and \citet[pp.~47--49]{Kam2008} \ifnotpaper (see
              \Cref{fig:threeWaySyns}) \fi but listed separately by
    ...
    \item % Discrep count (SYNS, WRONG): {PetersAndPedrycz2000}
          \refHelper \citeauthor{PetersAndPedrycz2000} \multiAuthHelper{claim}
