\begin{enumerate}
    ...
    \item % Discrep count (DEFS, OVER): {IEEE2022} | {IEEE2022}
    ...
    \item % Discrep count (TERMS, WRONG): {IEEE2021} {SWEBOK2024} {SWEBOK2014}
          % Discrep count (DEFS, CONTRA): {IEEE2021} | {SWEBOK2024} {SWEBOK2014}
    ...
    \item % Discrep count (DEFS, CONTRA): {IEEE2017} {SWEBOK2024} {Firesmith2015} {AmmannAndOffutt2017} {PetersAndPedrycz2000} | {IEEE2022} {Gerrard2000a}
          % Label DEFS static-test-discrep 
    ...
    \item % Discrep count (SYNS, OVER): {IEEE2017} {IEEE2013} | {IEEE2022} {IEEE2017} {Perry2006}
          ...
          \fi.
    \item % Discrep count (DEFS, OVER): {IEEE2010} | {IEEE2010}
    ...
    \item % Discrep count (DEFS, OVER): {IEEE2010} {SWEBOK2024}
          ...
          % STD | META
    \item % Discrep count (CATS, WRONG): {IEEE2022} {IEEE2021} {IEEE2017} | ISTQB
    ...
    \item % Discrep count (SYNS, WRONG): {IEEE2010} {SWEBOK2024} {vanVliet2000} | {Patton2006}
          ...
          ``fault'', ``defect'' are significant and meaningful \ifnotpaper
              ...
              \cite[p.~12\=/3]{SWEBOK2024}\fi, but \bugPattonDiscrep{}
    ...
    \item % Discrep count (SYNS, WRONG): {PetersAndPedrycz2000} | {PetersAndPedrycz2000}
    ...
    \item % Discrep count (DEFS, CONTRA): {vanVliet2000} | implied by {Patton2006}
          ...
          % TEXT | PAPER
    \item % Discrep count (DEFS, WRONG): ISTQB | {Kam2008}
