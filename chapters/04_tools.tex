...
\ifnotpaper
    ...
    omit this from \Cref{fig:exampleParChdGraphs,fig:exampleFlawGraphs} for
    brevity, \Cref{fig:expSynGraph} demonstrates how we represent the
    credibility of each relation in our visualizations.
