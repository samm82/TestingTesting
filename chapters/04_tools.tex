...
subsets of them. \ifnotpaper For each approach category (see
    ...
    as in \Cref{fig:staticExampleGraph}, to distinguish them, and include this
    in the legend of \Cref{fig:exampleGraphs} for convenience. If we assume
    that the approaches in \Cref{fig:exampleGraph,fig:rigidExampleGraph,%
        fig:synExampleGraph,fig:selfExampleGraph,fig:parSynExampleGraph} are
    all static, then this portion of the legend applies to the entirety of
    \Cref{fig:exampleGraphs}; otherwise, it does not apply to the
    aforementioned subgraphs.\qtodo{Does this make sense?}
