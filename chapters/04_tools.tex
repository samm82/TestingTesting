...
\ifnotpaper We can describe these graphs formally as ordered triplets
    ...
    inferences (see \Cref{infers}) and proposals (see \Cref{recs}),
    although we omit this from \Cref{fig:exampleGraphs} for brevity.
...
\ifnotpaper
    ...
    is the explicit version of \Cref{fig:exampleGraph}.
