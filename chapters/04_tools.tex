...
to visualize them. \ifnotpaper%
    ...
    approach ``X'' does not appear since it is not defined independently and
    does not violate transitivity). If a test approach does not have one of
    ...
    \qtodo{Is it OK to ``define'' \emph{orphan} here? We use the term
        ...
        relations first.}
    approach (in constrast to the ``parent'' and ``child'' approaches defined in
