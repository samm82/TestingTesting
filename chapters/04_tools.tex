...
\begin{description}
    \item[1. (Excluded)] \phantomsection{}\label{case-one}
          \hfill \ifnotpaper
              $\left\{ \{x, y\} \in S \mid x \in A \oplus y \in A \right\}$
          \fi \break
    ...
    \item[3. (Included)] \phantomsection{}\label{case-three}
          \hfill \ifnotpaper
              $\left\{ \{x, z\}, \{y, z\} \in S \mid x, y \in A \land
                  z \notin A \right\}$
          \fi \break
...
\ifnotpaper
    ...
    generate our graphs. We automatically generate the lists in
    \Cref{multiSyns,infMultiSyns} based on glossary entries such as those in
