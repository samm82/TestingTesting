...
\ifnotpaper
    ...
    \input{assets/tables/expAnalysis}
    ...
    \newpage  % Likely to be removed once the explicitness section is finalized
...
\ifnotpaper
    ...
    omit this from \Cref{fig:exampleParChdGraphs,fig:exampleGraphs} for brevity,
    \Cref{fig:expSynGraph} demonstrates how we represent the credibility of
    each relation in our visualizations.
