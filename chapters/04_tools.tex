...
\ifnotpaper
    ...
    % including more detailed analysis, error corrections, and the addition of data. 
    ...
    % Besides being more systematic, this 
    Automation also allows us to observe the impacts of smaller changes
    %, such as unexpected flaws that arise from a new relation between
    %two approaches. It also 
    ...
    double-check. Additionally, we define \LaTeX{} macros (\Cref{macros}) to
