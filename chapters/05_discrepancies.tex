...
terms that are not synonyms themselves. \ifnotpaper Sometimes, these terms
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \draw[thick] (ust) -- (st)  node [midway, below, align=center] {\citealpISTQB{}};
            \draw[thick] (st)  -- (uct) node [midway, left,  align=center] {\citealpISTQB{};\\ \citealp[pp.~47--49]{Kam2008}};
            \draw[thick] (uct) -- (ust) node [midway, right, align=center] {\citealp[p.~48]{Kam2008}\\};
...
listed below\else. The following four are the most prominent examples\fi:
