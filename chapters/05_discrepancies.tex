...
\Cref{tab:parSyns} and \discrepref{use-case-scenario}).
...
There are also pairs of synonyms where one is described as a sub-approach
...
given in \Cref{tab:parSyns}\ifnotpaper\ (additional pairs where a discrepancy
...
``is equivalent to exhaustively testing the program''\footnote{The
    contradictory definitions of path testing given in \discrepref{path-test}
...
\ifnotpaper
    ...
    ``path testing'' (see \discrepref{path-test})!
