...
of how and how frequently they tend to appear. Based on the observed
discrepancies, the following categories arose:

\begin{itemize}
    \item \textbf{Synonyms:} discrepancies with synonym relations of test
          approaches,
    \item \textbf{Parents:} discrepancies with \nameref{par-chd-rels} of
          test approaches,
    \item \textbf{Categories:} discrepancies with \nameref{categories-observ},
    \item \textbf{Definitions:} discrepancies with definitions of test
          approaches and related supplementary terminology,
    \item \textbf{Terminology:} discrepancies with the terms used for test
          approaches and related supplementary terminology (these are different
          from ``definition discrepancies'' since they focus on the labels
          used for terms, such as when one name is used when another should
          have been), and
    \item \textbf{Sources:} discrepancies with the citations given for
          referenced information (such as when a source is claimed to explain
...
\subsection{Synonym Relation Discrepancies}
\label{syns}
...
\input{chapters/05a_syn_discreps}
...
\subsection{Parent-Child Relation Discrepancies}
\label{par-rels}

\input{chapters/05b_par_discreps}
...
\subsection{Test Approach Category Discrepancies}
...
\input{chapters/05c_cat_discreps}
...
\subsection{Definition Discrepancies}
\label{def-discreps}
...
\input{chapters/05d_def_discreps}

\subsection{Terminology Discrepancies}
...
discrepancies seemed different enough to merit their own category. \ifnotpaper
    ...
    that are redundant or have typos. \fi The following \ifnotpaper
    discrepancies are presented in that order\else are examples of these
    discrepancies\fi:

\input{chapters/05e_term_discreps}

\subsection{Source Discrepancies}
\input{chapters/05f_src_discreps}
...
% Discrep count (DEFS): {IEEE2022} | {IEEE2017} ISTQB {ISO_IEC2023a}
...
% Discrep count (SYNS): implied by {IEEE2021} | {IEEE2022}
...
% Discrep count (SYNS): {Kam2008} | {IEEE2022}
