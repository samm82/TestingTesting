...
\hyperref[sources]{source category}. Note that all manually tracked
discrepancies appear in both sections, while those
\hyperref[auto-discrep-analysis]{automatically} uncovered based on semantics
are only listed in their appropriate \hyperref[discrepCategories]{category}.

A summary of how many
discrepancies there are by category is shown in \refDiscrepsTable{},
