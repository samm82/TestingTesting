...
Out of the automatically determined discrepancies given in \Cref{tab:multiCats},
of particular note is experience-based testing. \expBasedCatMain{}
...
if these categories are orthogonal. Inconsistencies between parent and child
test approach categorizations such as these may indicate that categories are
not transitive or that more thought must be given to them.
