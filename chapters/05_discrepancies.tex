...
the discrepancy manifests in. These include discrepancies with \syns{},
\pars{}, \cats{}, \defs{}, \terms{}, and \srcs{}.

\subsubsection{Synonym Discrepancies}
\label{syns}
\input{build/DiscrepCatSyns}

\subsubsection{Parent Discrepancies}
\label{pars}
\input{build/DiscrepCatPars}

\subsubsection{Categorie Discrepancies}
\label{cats}
