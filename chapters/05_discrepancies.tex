...
\begin{enumerate}
    ...
    \item % Discrep count (SYNS): {PetersAndPedrycz2000}
          \refHelper \citeauthor{PetersAndPedrycz2000} \ifnotpaper claim \else
    ...
    \item % Discrep count (SYNS): ISTQB | {Patton2006}
          % TODO: NEAR SYNS?
          \refHelper \ifnotpaper \citetISTQB{} claim \else claims \fi that code
          inspections are related to peer reviews but
    ...
    \item % Discrep count (SYNS): ISTQB | {PetersAndPedrycz2000}
          ...
          \ifnotpaper
    \item \refHelper \citet[p.~18]{SneedAndGöschl2000}\todo{OG Hetzel88}
          \ifnotpaper give \else gives \fi ``white-'',
    ...
    \item \refHelper \citet[p.~46]{Kam2008} seems to imply that ``mutation
...
\begin{enumerate}
    \item % Discrep count (PARS): {ISO_IEC2023a} | {Firesmith2015}
          ...
          are given as subtypes of reliability testing by \citep{ISO_IEC2023a},
...
\input{chapters/05f_def_discreps}
