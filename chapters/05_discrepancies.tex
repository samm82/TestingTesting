...
input data and implementation issues on the the code's behaviour
\citep[pp.~467, 476, respectively]{PetersAndPedrycz2000}. Exhaustive
testing requires ``all combinations of input values \emph{and} preconditions
\dots{} [to be] tested'' \ifnotpaper
    (\citealp[p.~4, emphasis added]{IEEE2022}; similar in \citealpISTQB{})\else
    \cite[p.~4]{IEEE2022} (similar in \citealpISTQB{})\fi.
