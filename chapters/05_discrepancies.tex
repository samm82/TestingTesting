...
After gathering all this data\footnote{Available in \texttt{ApproachGlossary.csv}
      ...
      \ifblind{[Repository link suppressed]}{TODO}.}, we found many discrepancies
...
causing confusion. \ifnotpaper These \else Fourteen of these pairs were identified
      through automatic analysis of the
      generated graphs. The seven pairs where each relation has a concrete
      source \fi are given in \Cref{tab:parSyns}.
...
\ifnotpaper
      ...
      \end{itemize}
\else % \input{assets/misc/parSyns} Moved earlier to display nicely in paper
\fi
