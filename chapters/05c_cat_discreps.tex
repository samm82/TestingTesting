\begin{enumerate}
    \item % Discrep count (CATS): {IEEE2022}
          ...
          \ifnotpaper
              \begin{itemize}
                  \item % Discrep count (CATS): {IEEE2021} | {IEEE2022} {IEEE2021} {SWEBOK2024} ISTQB
                  ...
                  \item % Discrep count (CATS): {IEEE2022}
                        % Discrep count (CATS): {IEEE2022} {IEEE2021} | {SWEBOK2024}
    ...
    \item The following test approaches are categorized as test
          ...
          sources provided:
          \begin{enumerate}
              \item % Discrep count (CATS): {IEEE2021} | {IEEE2022} {IEEE2013} implied by {ISO_IEC2023a} {IEEE2021} {Firesmith2015}
                    Capacity testing
                    \ifnotpaper
                    ...
                    \fi,
              \item % Discrep count (CATS): {IEEE2021} | {IEEE2013} implied by {Firesmith2015}
                    Endurance testing
                    \ifnotpaper
                    ...
                    \else
                        \cite[p.~2]{IEEE2013}%
                    \fi,
              \item % Discrep count (CATS): {IEEE2021} | {IEEE2022} {IEEE2017} {IEEE2013} ISTQB implied by {Firesmith2015}
                    Load testing
                    \ifnotpaper
                    ...
                    \fi,
              \item % Discrep count (CATS): {IEEE2021} | {IEEE2022} {IEEE2021} implied by {Firesmith2015}
                    Performance testing
                    \ifnotpaper
                    ...
                    \fi, and
              \item % Discrep count (CATS): {IEEE2021} | {IEEE2022} {IEEE2017} implied by {Firesmith2015}
                    Stress testing
                    \ifnotpaper
                    ...
                    \fi.
          \end{enumerate}
    \item % Discrep count (CATS): {IEEE2022} {IEEE2021} | {PetersAndPedrycz2000}
    ...
    \item % Discrep count (CATS): {IEEE2022} {IEEE2021} | {Kam2008} implied by {IEEE2021} {IEEE2017}
          ...
          \else
              \cite[p.~4]{Kam2008}%
          \fi.
    \item % Discrep count (CATS): {IEEE2022} | {Kam2008}
    ...
    \item % Discrep count (CATS): {SWEBOK2024} | {Kam2008}
