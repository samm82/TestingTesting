\begin{enumerate}
    \item % Discrep count (CATS, CONTRA): {IEEE2022}
          ...
          \ifnotpaper
              \begin{itemize}
                  \item % Discrep count (CATS, AMBI): {IEEE2021} | {IEEE2022} {IEEE2021} {SWEBOK2024} ISTQB
                        ...
                        % Discrep TODO count (CATS, CONTRA): {IEEE2021} | {Firesmith2015}
    ...
    \item The following test approaches are categorized as test
          ...
          sources provided:
          \begin{enumerate}
              \item % Discrep count (CATS, CONTRA): {IEEE2021} | {IEEE2022} {IEEE2013} implied by {ISO_IEC2023a} {IEEE2021} {Firesmith2015}
                    Capacity testing
                    \ifnotpaper
                    ...
                    \fi,
              \item % Discrep count (CATS, CONTRA): {IEEE2021} | {IEEE2013} implied by {Firesmith2015}
                    Endurance testing
                    \ifnotpaper
                    ...
                    \else
                        \cite[p.~2]{IEEE2013}%
                    \fi,
              \item % Discrep count (CATS, CONTRA): {IEEE2021} | {IEEE2022} {IEEE2017} {IEEE2013} ISTQB implied by {Firesmith2015}
                    Load testing
                    \ifnotpaper
                    ...
                    \fi,
              \item % Discrep count (CATS, CONTRA): {IEEE2021} | {IEEE2022} {IEEE2021} implied by {Firesmith2015}
                    Performance testing
                    \ifnotpaper
                    ...
                    \fi, and
              \item % Discrep count (CATS, CONTRA): {IEEE2021} | {IEEE2022} {IEEE2017} implied by {Firesmith2015}
                    Stress testing
                    \ifnotpaper
