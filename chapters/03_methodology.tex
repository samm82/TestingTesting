...
literature. While sources usually present information explicitly, some
information is more implicit and therefore more subjective. We call
...
\begin{enumerate}
    ...
    \item \textbf{One is a superset of the other.} In other words, for one
          ...
          decomposed into smaller approaches that can be performed
          independently. Performing all known subapproaches then logically
          implies that the parent approach has also been performed! In
          practice, this is harder to prove; although many hierarchies exist
          (such as \citealp[Fig.~2]{IEEE2022}, \citeyear[Fig.~2]{IEEE2021},
          and those in \citealp{Firesmith2015}), they are likely incomplete.
\end{enumerate}
