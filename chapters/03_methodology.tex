...
\fi Each tier is given a unique colour in \Cref{fig:recovery-graph-current,%
...
such as the \acf{istqb}, but not always: we include \ifnotpaper
    \citeauthor{Firesmith2015}\else Firesmith\fi's taxonomy
\citeyearpar{Firesmith2015} and \ifnotpaper \citeauthor{DoğanEtAl2014}\else
    Doğan et al.\fi's literature review \citeyearpar{DoğanEtAl2014} because of
their broad scope and applicability\todo{I should probably expand on this}.
