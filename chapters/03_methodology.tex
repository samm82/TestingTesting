...
\begin{enumerate}
    ...
    \item \textbf{One is ``stronger than'' or ``subsumes'' the other.} When
          ...
          relations from \ifnotpaper (\citealp[Fig.~F.1]{IEEE2021};
              \citealp[Fig.~13.17]{vanVliet2000}) \else \cite[Fig.~F.1]{IEEE2021},
              \citealp[Fig.~13.17]{vanVliet2000} \fi in the subdomain of data
          flow testing can be found in \Cref{fig:subsumesGraph} (along with
    ...
    \item \textbf{The parent approach is part of an orthogonal set.}
          ...
          usability testing as static \emph{and} dynamic and 12 approaches as
          able to ``be done manually \emph{or} using a tool''
