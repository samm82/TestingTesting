...
indicate they should be investigated further (see \Cref{undef-terms}). A
similar methodology is used for tracking software qualities, albeit in a
separate document\ifnotpaper\ (see \Cref{qual-test})\fi.
