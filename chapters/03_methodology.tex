...
and \nameref{discrep-cats} arose naturally from the literature. Even though
these are ``results'' of this research, they are defined here for clarity since
they are used throughout this thesis. We also define the notion of
\nameref{rigidity}.
...
\ifnotpaper
    ...
    to be out of the scope of this project (see \Cref{scope}, \thesisissueref{21},
    and \thesisissueref{22}).
...
\subsubsection{Categories of Discrepancies}
\label{discrep-cats}

Since there are many discrepancies in the literature, it is useful to decompose
them into categories to count, analyze, and discuss them in a more focused way.
The following categories are used, based on the types of discepancies observed:
