...
\latertodo{Ensure this list is current!}.
This allows us to provide a more complete picture of the state of the
literature; for example, we can view implicit flaws separately in
\Cref{tab:sntxFlaws,tab:smntcFlaws}, since additional context may rectify
them. All sources cited throughout this \docType{} support their respective
