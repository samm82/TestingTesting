...
\end{enumerate}
A summary of how many sources comprise each tier is
...
This tier is composed of \stdSources{2} .
...
present. Some of these are not peer-reviewed works, but they show how terms are
used in practice\thesisissueref{89}:
