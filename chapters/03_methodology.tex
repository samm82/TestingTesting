...
most central to our research is \ourApproachGlossary{}, where we record all
test approaches we identify in the literature. We use heuristics to guide this
process to increase confidence that we identify all terms, paying
...
We give each test approach its own row in \ourApproachGlossary{} to record its
name and any given \approachFields{}.
...
Applying our procedure from \Cref{procedure} to these sources uncovers
