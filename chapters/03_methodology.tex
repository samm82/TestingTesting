...
system testing, and acceptance testing as examples of test levels \ifnotpaper
    ...
    \cite[pp.~9,~13]{Gerrard2000a}, \cite[pp.~807--808]{Perry2006},
...
manageable subsets, these categories are used for now. \ifnotpaper \par
...
\Cref{tab:otherTestTerms} and may provide other perspectives when determining
...
\Cref{tab:ieeeTestTerms}, but are given in \Cref{tab:otherCategorizations} for
...
category from \Cref{tab:ieeeTestTerms} it seems to subdivide. The sources
