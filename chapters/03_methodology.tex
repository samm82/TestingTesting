...
these are less-defined and as such are not used in this \ifnotpaper thesis\else
    paper\fi, they are given here for
...
It is still useful to understand these differences because some subsets,
...
However, other subsets may have ``conditions that make one approach more
effective than the other'', such as deterministic and random
\citep[p.~5-16]{SWEBOK2024}. The following categories may be more relevant
...
\begin{itemize}
    ...
    \item Source of information for design: specification-based, structure-based, or
          experience-based testing \citep[p.~8]{IEEE2021}
          \begin{itemize}
