...
with the information provided in the source that mentions it. We then repeat
this process with the relevant data from our quality glossary, then remove its
entry (since it has now been ``upgraded'' to a test type).
