...
categories. \ifnotpaper The following examples are given by their respective
    sources; we indicate the combination for the first item but omit the rest
    for brevity as the name makes it clear what the combination is:
...
categories given in \Cref{categories-observ,tab:ieeeCats}, such as
...
\Cref{tab:ieeeCats} and some outliers (e.g., ``artifact''%
