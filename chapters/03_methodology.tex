...
a classification for different kinds of tests (see \Cref{tab:ieeeTestTerms}).
...
categories (see \Cref{tab:otherTestTerms}) which may be beneficial to
investigate to determine if this categorization is sufficient.
...
(see \Cref{graph-gen,discrep-analysis}, respectively) by looking for indicators
