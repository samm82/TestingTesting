...
techniques, practices, or static testing \citeyearpar[Fig.~2; see
    \Cref{tab:ieeeCats}]{IEEE2022}. However, static testing seems to be
non-orthogonal and thus less helpful for categorizing test approaches.
...
``practice''. Based on observations such as this, we categorize static testing
approaches based on the remaining categories from \citet{IEEE2022}: approach,
level, type, technique, and practice. \ifnotpaper However, since there are many
    ways to categorize test approaches (see \Cref{tab:otherCats,%
        tab:otherCategorizations}), considering static testing separately may not
    be entirely incorrect and may have merit in specific contexts. \fi
