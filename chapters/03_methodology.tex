...
type'' in particular) seem to be widely used. For example,
\citet[pp.~443-445,~446, respectively]{PetersAndPedrycz2000}
\multAuthHelper{use} both, although use a more general notion of ``test type''.
Because of their widespread use and their usefulness when focusing on a particular
subset of testing, these categories are used for now. \ifnotpaper A ``metric''
...
\begin{itemize}
    ...
    \item Level/stage\footnote{See \Cref{tab:ieeeTestTerms}.} of testing:
