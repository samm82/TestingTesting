...
\begin{itemize}
    \item \textbf{Error:} ``a human action that produces an incorrect result''
          \ifnotpaper (\citealp[p.~165]{IEEE2017}\todo{OG IEEE, 2009};
              \citeyear[p.~128]{IEEE2010}; \citealp[p.~399]{vanVliet2000})\else
              \cite[p.~128]{IEEE2010}, \cite[p.~165]{IEEE2017},
              \cite[p.~399]{vanVliet2000}\fi.
    ...
    \item \textbf{Defect:} ``an imperfection or deficiency in a project
          ...
          \ifnotpaper (\citealp[p.~124]{IEEE2017}\todo{OG PMBOK};
              \citeyear[p.~96]{IEEE2010})\else \cite[p.~96]{IEEE2010},
              \cite[p.~124]{IEEE2017}\fi.
\end{itemize}
This distinction is sometimes important, but not always
\citep[p.~4\=/3]{SWEBOK2014}\todo{OG IEEE, 1996}. The term ``defect'' is
...
refer to all different types of anomalies'' \ifnotpaper
    ...
    \citeyear[p.~96]{IEEE2010}\todo{OG IEEE, 2024})\else \cite[p.~12\=/3]{SWEBOK2025}
