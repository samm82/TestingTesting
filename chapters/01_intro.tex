...
these nuances completely! \bugPattonFlaw{}
...
These types of ambiguities\qtodo{Is this OK to use here w.r.t.
    \#140?} can lead to miscommunications---such as that
...
is still quite flawed (\Cref{discreps}). This reinforces the need for a proper
