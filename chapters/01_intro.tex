...
\ifnotpaper
    The following three \acfp{rq} guide this process:
    \begin{enumerate}
        \item \rqatext{}
        \item \rqbtext{}
        \item \rqctext{}
...
are used for testing things other than code, and some approaches can be
used for both! In these cases, only the subsections of these approaches
focused on code are considered. For example, reliability testing and
maintainability testing can start \emph{without} code by ``measur[ing]
...
\ifnotpaper
    ...
    this document; we exclude some practices either in full, such as hardware
