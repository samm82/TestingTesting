...
be approached systematically and rigorously. \refHelper
\citet[p.~3]{PetersAndPedrycz2000} \multiAuthHelper{claim} that ``to be
successful, development of software systems requires an engineering approach''
that is ``characterized by a practical, orderly, and
measured development of software''. When a NATO study group decided to hold a
conference to discuss ``the problems of software'' in 1968, they chose the
...
Unfortunately, this lack of consensus in the field of software engineering
persists to this day, including in the subdomain of software testing.
...
robustness, the same should apply to its supporting literature! \ifnotpaper
    ...
    \citep{HuntEtAl2021}. \fi Unfortunately, a search for a systematic,
