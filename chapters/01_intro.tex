...
\begin{itemize}
    \item \textbf{Error:} ``a human action that produces an incorrect result''
          \ifnotpaper (\citealp[p.~165]{IEEE2017}; \citeyear[p.~128]{IEEE2010};
              \citealp[p.~399]{vanVliet2000})\else \cite[p.~128]{IEEE2010},
              \cite[p.~165]{IEEE2017}, \cite[p.~399]{vanVliet2000}\fi.
    ...
    \item \textbf{Failure:} the inability of a system ``to perform a required
          ...
          ``externally visible'' \ifnotpaper (\citealp[p.~7]{IEEE2019a}; similar
              in \citealp[p.~5\=/3]{SWEBOK2025}; \citealp[p.~400]{vanVliet2000})
          \else \cite[p.~7]{IEEE2019a} (similar in \cite[p.~400]{vanVliet2000},
              \cite[p.~5\=/3]{SWEBOK2025}) \fi and caused by a fault \ifnotpaper
              (\citealp[p.~12\=/3]{SWEBOK2025}; \citealp[p.~400]{vanVliet2000})%
          \else \cite[p.~400]{vanVliet2000}, \cite[p.~12\=/3]{SWEBOK2025}\fi.
...
\end{itemize}
These distinctions are often important, but ``defect'' is often used as a
generic term to refer to either a fault (cause) or a failure (effect)''
\ifnotpaper (\citealp[p.~124]{IEEE2017}\todo{OG IEEE 982\-/2024};
    \citeyear[p.~96]{IEEE2010}\todo{OG IEEE 982-2024};
    \citealp[p.~13]{Lyu1996}) \else \cite[p.~96]{IEEE2010}, \cite[p.~124]{IEEE2017},
    \cite[p.~13]{Lyu1996} \fi ``when the distinction between fault and failure
is not critical'' \citetext{p.~13}. % \citealp[p.~13]{Lyu1996}.
This makes the term ``defect'' ``overloaded with too many meanings, as
