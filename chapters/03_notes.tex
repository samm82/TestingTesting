...
\citep[p.~5013]{SWEBOK2024}), thus maximizing the path coverage.
...
approaches from 403 to 466 and the number of \emph{undefined} terms from 146 to
175 (the generalization can be made that 46\% of added terms also included a
definition):
