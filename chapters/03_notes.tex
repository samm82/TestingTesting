...
\begin{itemize}
      \item Often done with Abstract Syntax Trees (ADTs)
            \todo{investigate more: Steele 1990?}
...
\subsubsection{Macro Models \cite[p.~113:3-7]{lilis_survey_2019}}
\begin{itemize}
...
\subsubsubsection{Lexical Macros}
\begin{itemize}
...
\subsubsubsection{Syntactic Macros}
\begin{itemize}
