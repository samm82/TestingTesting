...
\begin{enumerate}
      ...
      \item Humorously, ``loop testing'' is in scope when referring to loops
            in software \citep{Patton2006, vanVliet2000, PetersAndPedrycz2000,
                  DhokAndRamanathan2016, GodefroidAndLuchaup2011}, not loops
            in chemical systems \citep{Dominguez-PumarEtAl2020}, wide-area
            damping controllers \citep{PierreEtAl2017, TrudnowskiEtAl2017} or
            copper loops \citep{Goralski1999}!
\end{enumerate}
