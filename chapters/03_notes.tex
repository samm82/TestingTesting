...
\begin{itemize}
      ...
      \item Instead of evaluating the generated code, it is more beneficial
            ``to statically check the generator and be sure that no type error
            arises during its \emph{run time}''; however, ``an error in the
            generated program can be very hard to debug and may require full
            understanding of the generator itself''
