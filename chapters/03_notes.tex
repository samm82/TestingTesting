...
\cite{barbosa_towards_2006} gives the following: testing process, phase,
artifact, step, procedure, and resource \cite[p.~2]{barbosa_towards_2006},
...
\begin{itemize}
      \item The only testing phases described are unit, integration, and
            regression testing \cite[p.~3]{barbosa_towards_2006}
      \item The role of a testing artifact is not specified; requirements,
            drivers, and source code are all treated the same with no
            distinction \cite[p.~3]{barbosa_towards_2006}
      \item ``Testing procedures can be categorized in testing methods,
            testing guidances and testing techniques'', and ``functional,
            structural, error-based and state-based'' are examples of
