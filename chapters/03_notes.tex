...
\begin{itemize}
      ...
      \item Installation testing: Focuses on the portability of the product,
            ...
            has been developed'' \cite[p.~439]{van_vliet_software_2000}
\end{itemize}
...
\begin{itemize}
      \item Statement/line coverage: ``execut[ing] every statement in the
            program at least once''; doesn't guarantee correctness
      ...
      \item Branch coverage: attempting to, ``at each branching node in the
            ...
            once''; stronger than statement coverage, but doesn't guarantee
      ...
      \item Path coverage: ``[a]ttempting to cover all the paths in the
            software'' \cite[p.~119]{patton_software_2006}; stronger than
            branch coverage \cite[p.~433]{van_vliet_software_2000} and, if done
            completely, ``is equivalent to exhaustively testing the program''
            (this is generally ``not possible'' due to the complexity of loops,
      ...
      \item (Multiple) condition coverage: ``takes the extra conditions on the
            ...
            Boolean expression) \cite[p.~120]{patton_software_2006}; does not
            subsume and is not subsumed by path coverage
            \cite[p.~433]{van_vliet_software_2000} (``also
