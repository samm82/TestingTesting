...
\begin{enumerate}
      ...
      \item Since feedback loops often have a software \emph{and} hardware
            component (see \citep{PreußeEtAl2012}), only the software component
            is in scope. In some cases, it is unclear whether the ``loops''
            being tested are implemented by software or hardware, such as those
            in wide-area damping controllers \citep{PierreEtAl2017,
                  TrudnowskiEtAl2017}. Humorously, the testing of loops in
            chemical systems \citep{Dominguez-PumarEtAl2020} or made of copper
            \citep{Goralski1999} are out of scope.
\end{enumerate}
