...
\label{chap:testing:sec:software-metrics}
...
\label{chap:testing:sec:software-testing}
...
and infrastructure''. \textbf{NOTE:} While all the examples of domain-specific
...
static techniques as well'' \citep[p.~5-2]{SWEBOK2024} (such as
\citep[pp.~8-9]{Gerrard2000} and even \citep[p.~440]{IEEE2017}!), the scope of
``testing'' for the purpose of this
...
\phantomsection{}
\label{chap:testing:sec:derived-from-qualities}
...
(see \hyperref[chap:testing:sec:derived-from-qualities]{Scope (of derived test types)}).
...
\begin{enumerate}
      ...
      \item It is ambiguous whether ``tool/environment testing'' refers to
            ...
            them to test the object under test; the latter is implied by the
            structure presented on page 25 of \citep{Firesmith2015}, but the
            wording of its subtypes seems to imply the former
      ...
      \item While \citeauthor{Firesmith2015} says that fault tolerance testing
            is a subtype of robustness testing \citeyearpar[p.~56]{Firesmith2015}
...
\begin{itemize}
      ...
      \item Question: what-, when-, where-, who-, why-, how-, and how-well-based
            ...
            testing types''\footnote{Not formally defined, but distinct from
                  the notion of ``test type'' described in
                  \nameref{tab:ieeeTestTerms}.} \citep[p.~17]{Firesmith2015}
