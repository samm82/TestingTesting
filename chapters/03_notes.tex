...
products'' \citep[p.~28]{Gerrard2000b} are not. While orthogonal array testing
can be used when testing software \citep{Mandl1985}, a subset of it called
``Taguchi's orthogonal array testing (TOAT)'' for ``experimental design
problems in manufacturing'' \citep[p.~1573]{YuEtAl2011} or ``product and
manufacturing process design'' \cite[p.~44]{Tsui2007} and is thus out of
scope.
...
\begin{itemize}
      ...
      \item \textbf{Orthogonal Array Testing\footnote{
                        ...
                        out-of-scope examples.}:} \citet{Mandl1985}
\end{itemize}
