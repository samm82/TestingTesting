...
\phantomsection{}
\label{chap:notes:sec:derived-scope}
Since it seemed that testing types can be derived from software qualities
(see \thesisissueref{21} and \thesisissueref{23}), it was decided that tracking
...
(see \hyperref[chap:notes:sec:derived-scope]{Scope (of derived test types)}).
...
\begin{enumerate}
      \item ``Compatibility testing'' is defined as ``testing that measures the
            ...
            ``interoperability'' being given by \citet{ISTQB} and
            \citet[pp.~73, 237]{IEEE2017}, as well as the definition of
