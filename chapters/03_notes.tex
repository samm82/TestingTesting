...
\citep{IEEE2022, IEEE2017, IEEE2013, ISO_IEC2023, IEEE2012, SWEBOK2014, ISTQB}.
...
\begin{enumerate}
      ...
      \item ``Functional testing'' is given a loose definition of testing
            ...
            \cite{ISTQB} define this and ``specification-based''
      ...
      \item A component is an ``entity with discrete structure \dots within a
            ...
            \citep{ISO_IEC2023} and ``the terms module, component, and unit
...
terminology (see \refIEEETestTerms).
