...
Many subsets of the current state of testing literature contain discrepancies
and ambiguities. The following sections outline some of the larger ones,
followed by more \nameref{minor-discrep}, both among sources and within
...
throughput, or database size \citep{ISO_IEC2023a}.
...
\begin{itemize}
      \item \textbf{Scalability:} ``the software's ability to increase and
            ...
            transactions, and volume of data'' (p.~5-5)
      \item \textbf{Elasticity Testing:} testing that ``assesses the ability of
            the \acs{sut} \dots\ to rapidly expand or shrink compute, memory,
            and storage resources without compromising the capacity to meet
            peak utilization'' (p.~5-9)
\end{itemize}
...
a short period'' (\citeyear{Pandey2023}; see \thesisissueref{35}).
...
\subsubsection{Minor Discrepancies}
\label{minor-discrep}
...
\paragraph{Discrepancies in Standards}
...
\paragraph{Discrepancies in ``Meta-Level'' Sources}

The following discrepancies are either intrinsic to SWEBOK \citep{SWEBOK2024,
...
\paragraph{Discrepancies in McMaster-Trusted Sources}
...
\paragraph{Discrepancies in Other Sources}
