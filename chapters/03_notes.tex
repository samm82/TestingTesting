...
\begin{itemize}
      ...
      \item Acceptance testing: Like system testing ``often performed under
            supervision of the user organization'' that focuses on usability
            \cite[p.~439]{van_vliet_software_2000}
      ...
      \item Many forms:
            \begin{itemize}
                  ...
                  \item Inspection: Someone who is \emph{not} the author of the
                        ...
                        \cite[p.~95]{patton_software_2006}.
            \end{itemize}
...
``highly formal methods of logic'' \cite[p.~438]{peters_software_2000}, so this
is not often used and its value is ``sometimes disputed''
\cite[p.~418]{van_vliet_software_2000}. \emph{Could be useful for Drasil down
...
\begin{itemize}
      ...
      \item Branch coverage: attempting to, ``at each branching node in the
            ...
            \begin{itemize}
                  \item Stronger than statement coverage, but doesn't guarantee
                        correctness \cite[p.~421]{van_vliet_software_2000}
      ...
      \item Path coverage: ``[a]ttempting to cover all the paths in the
            ...
            \begin{itemize}
                  \item Stronger than branch coverage
                        \cite[p.~433]{van_vliet_software_2000}
                  \item I always thought the ``path'' in ``path coverage'' was
                        a path from program start to program end, where van
                        ...
                        \cite[p.~420]{van_vliet_software_2000}); this leads me
                        to some confusion in the following sections
                        \todo{Ask about this}
...
\begin{itemize}
      ...
      \item The three possible actions on data are defining, killing, and using;
            ...
            \cite[pp.~478,480]{peters_software_2000} \todo{get original source:
                  Beizer, 1990} (see ``Data reference errors'' in
...
\todo{How is All-DU-Paths coverage stronger than All-Uses coverage according to
      \cite[p.~433]{van_vliet_software_2000}?}
...
\begin{itemize}
      \item Repeating ``tests previously executed \dots at a later point in
            development and maintenance'' \cite[p.~446]{peters_software_2000}
      \item Various levels:
            \begin{itemize}
...
\begin{itemize}
      ...
      \item Undecidability: \todo{The textbook doesn't elaborate on this?}
            \cite[p.~439]{peters_software_2000}
\end{itemize}
