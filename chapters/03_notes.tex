...
(\citealp[p.~15]{IEEE2022}; \citeyear[p.~7]{IEEE2021}). However, some testing
approaches are categorized differently by different sources; these differences
are noted so that they can be analyzed more systematically.
...
implied by \citealp[p.~7]{IEEE2021}).
...
\citealp[p.~5-11]{SWEBOK2024}; \citetalias{ISTQB}) and data flow testing
