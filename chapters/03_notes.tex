...
\begin{itemize}
      \item Unit/module testing: ``testing the individual modules [of a
                        program]'' \citep[p.~438]{van_vliet_software_2000};
            also called ``component testing'' \citep[p.~444]{peters_software_2000}.
            Note that since a \emph{component} is ``a part of a system that can
            be tested in isolation'' \citep{istqb_glossary}, this seems to apply
...
\citep[p.~79]{patton_software_2006}.

\paragraph{Logic Flow Testing \citep[pp.~80-84]{patton_software_2006}}
...
\citep[p.~482]{peters_software_2000}) \citep[p.~481]{peters_software_2000}.
