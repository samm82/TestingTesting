...
\begin{itemize}
      ...
      \item Meta-programming does not provide instant results; instead, the
            ...
            existing software artefacts \todo{British}, but not much is done and [sic]
...
\begin{itemize}
      ...
      \item Derived test oracle: any ``artefact[] \todo{British} from which a
            test oracle may be derived\em for instance, a previous version of
...
\begin{itemize}
      \item Should be done automatically \cite[p.~481]{peters_software_2000};
            ``[t]est suite augmentation techniques specialise \todo{British} in
...
\begin{itemize}
      ...
      \item Undecidability: \cite[p.~439]{peters_software_2000}
            \qtodo{The textbook doesn't elaborate on this?}
\end{itemize}
