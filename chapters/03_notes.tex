...
\dots\ processes and infrastructure'' \citepalias{ISTQB}, are also out of scope,
...
It also seems that these categories are orthogonal. For example, it originally
...
\dots\ techniques for designing test cases'', although they ``can use the test
techniques'' \citeyearpar[p.~viii]{IEEE2021}. This implies that the phrase
``experience-based test design technique'' refers to a technique that is used
\emph{by} the practice of experience-based testing, not that experience-based
testing is \emph{itself} a test technique, although this is not always clearly
articulated (\citealp[pp.~4,~22]{IEEE2022}; \citealp[p.~5-13]{SWEBOK2024};
\citetalias{ISTQB}) and is sometimes contradicted \citep[p.~46]{Firesmith2015}.
See \nameref{chap:testing:sec:orthogonal-tests}
for more potential examples of the orthogonality of testing categories.
...
\begin{itemize}
      \item Visibility of code: black-, white-, or gray-box (functional,
            ...
            \citealp[p.~601, called ``testing approaches'' and (stepwise) code
                  reading replaced ``gray-box testing'']{SharmaEtAl2021};
            \todo{OG [3, 4, 5, 8]}
...
\begin{enumerate}
      ...
      \item \citeauthor{Kam2008} also says that the goal of negative testing is
            ...
            \citepalias{ISTQB} (i.e., negative testing) is one way to help
            test this!
