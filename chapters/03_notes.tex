...
\textbf{NOTE:} While all the examples of domain-specific
...
approaches from 403 to 479 and the number of \emph{undefined} terms from 146 to
162 (the assumption can be made that about 79\% of added terms also included a
definition):
% 1 - [(undef after - undef before)] / (total after) - (total before)
