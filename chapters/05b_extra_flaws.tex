\begin{enumerate}
    ...
    \item % Flaw count (LABELS, WRONG): {IEEE2021}
    ...
    \item % Flaw count (LABELS, AMBI): {IEEE2019} {IEEE2010} | {SWEBOK2024}
          % Ground truth: {vanVliet2000}
    ...
    \item % Flaw count (LABELS, AMBI): {SWEBOK2024} | {SWEBOK2024}
          % Ground truth: {vanVliet2000}
          ...
          errors or faults.
    \item % Flaw count (LABELS, REDUN): {SWEBOK2024}
    ...
    \item % Flaw count (LABELS, WRONG): ISTQB
    ...
    \item % Flaw count (TRACE, WRONG): ISTQB
    ...
    \item % Flaw count (LABELS, OVER): {Firesmith2015} | {Firesmith2015}
          % Label OVER cat-acro
          ``Customer acceptance testing'' and ``contract(ual) acceptance
          testing'' have the same acronym (``CAT'') \citep[p.~30]{Firesmith2015}.
    \item % Flaw count (LABELS, OVER): {Firesmith2015} | {Firesmith2015} {PreußeEtAl2012}
          % Label OVER hil-acro
          ...
          for the former.
    \item % Flaw count (TRACE, WRONG): {DoğanEtAl2014}
          ...
          % META | TEXT
    \item % Flaw count (LABELS, CONTRA): {IEEE2021} {IEEE2017} {PetersAndPedrycz2000} | {vanVliet2000}
          % TODO: SUPP LABELS?
    ...
    \item % Flaw count (LABELS, CONTRA): {IEEE2021} {PetersAndPedrycz2000} | {vanVliet2000}
          % TODO: SUPP LABELS?
    ...
    \item % Flaw count (DEFS, CONTRA): {IEEE2017} | {SWEBOK2014} | {vanVliet2000}
          ...
          % TEXT | PAPER
    \item % Flaw count (LABELS, REDUN): {Gerrard2000a} | {IEEE2022} ISTQB
    ...
    \item % Flaw count (SYNS, WRONG): implied by {SharmaEtAl2021}
          ...
          \todo{FIND SOURCES}.
    \item % Flaw count (LABELS, WRONG): {Kam2008}
