\begin{enumerate}
    \item % Flaw count (DEFS, CONTRA): {IEEE2021} {IEEE2017} | {vanVliet2000} implied by {IEEE2021}
          % TODO: SUPP DEFS?
    ...
    \item % Flaw count (DEFS, CONTRA): {IEEE2021} | {IEEE2017}
          % TODO: SUPP DEFS?
    ...
    \item % Flaw count (DEFS, WRONG): {IEEE2017} | {IEEE2017}
          % TODO: SUPP DEFS?
    ...
    \item % Flaw count (DEFS, CONTRA): {IEEE2017} | {IEEE2021} {vanVliet2000} {PetersAndPedrycz2000}
    ...
    \item % Flaw count (CATS, WRONG): {IEEE2016} | {IEEE2016}
    ...
    \item % Flaw count (DEFS, AMBI): {IEEE2016} {IEEE2017} {IEEE2012} {vanVliet2000}
          % TODO: SUPP DEFS?
          ...
          imprecise.
    \item % Flaw count (CATS, CONTRA): {IEEE2022} | implied by {IEEE2022}
          ...
          may be considered a test technique.\footnote{For simplicity, this
              ...
              \Cref{tab:multiCats}.}
    \item % Flaw count (SYNS, CONTRA): implied by {IEEE2016} | {IEEE2022} {IEEE2016}
          ...
          % STD | META
    \item % Flaw count (DEFS, AMBI): {SWEBOK2024} | {SWEBOK2024}
          ...
          to software itself \citeyearpar[pp.~4\=/9, 6\=/5, 7\=/3, 12\=/4,
              ...
              runtime errors, and logical errors'' \citep[p.~16\=/13, cf.
                  p.~18\=/13]{SWEBOK2024} since they seem to be in different
              domains. Does that make sense? How should I document this?}
    \item % Flaw count (TERMS, AMBI): {IEEE2019} {IEEE2010} | {SWEBOK2024}
          % Ground truth: {vanVliet2000}
    ...
    \item % Flaw count (TERMS, AMBI): {SWEBOK2024} | {SWEBOK2024}
          % Ground truth: {vanVliet2000}
          ...
          errors or faults.
    \item % Flaw count (TERMS, REDUN): {SWEBOK2024}
    ...
    \item % Flaw count (DEFS, WRONG): ISTQB
    ...
    \item % Flaw count (DEFS, REDUN): ISTQB
    ...
    \item % Flaw count (TERMS, WRONG): ISTQB
    ...
    \item % Flaw count (CITES, WRONG): ISTQB
    ...
    \item % Flaw count (DEFS, AMBI): {Firesmith2015} | {Firesmith2015}
          ...
          \citetext{p.~33}.
    \item % Flaw count (DEFS, AMBI): {Firesmith2015}
    ...
    \item % Flaw count (TERMS, OVER): {Firesmith2015} | {Firesmith2015} {PreußeEtAl2012}
          ...
          for the former.
    \item % Flaw count (CITES, WRONG): {DoğanEtAl2014}
          ...
          % META | TEXT
    \item % Flaw count (TERMS, CONTRA): {IEEE2021} {IEEE2017} {PetersAndPedrycz2000} | {vanVliet2000}
          % TODO: SUPP TERMS?
    ...
    \item % Flaw count (TERMS, CONTRA): {IEEE2021} {PetersAndPedrycz2000} | {vanVliet2000}
          % TODO: SUPP TERMS?
    ...
    \item % Flaw count (DEFS, MISS): {IEEE2021} {IEEE2017} {PetersAndPedrycz2000} | {vanVliet2000}
    ...
    \item % Flaw count (DEFS, CONTRA): {vanVliet2000} | {IEEE2021} {IEEE2017} {PetersAndPedrycz2000}
    ...
    \item % Flaw count (DEFS, CONTRA): {vanVliet2000} | {IEEE2021} {IEEE2017} {SWEBOK2024} {PetersAndPedrycz2000}
    ...
    \item % Flaw count (DEFS, CONTRA): {vanVliet2000} | {IEEE2021}
    ...
    \item % Flaw count (DEFS, CONTRA): {vanVliet2000} | {SWEBOK2024}
    ...
    \item % Flaw count (PARS, WRONG): implied by {IEEE2021} | {PetersAndPedrycz2000}
    ...
    \item % Flaw count (DEFS, CONTRA): {IEEE2017} | {SWEBOK2014} | {vanVliet2000}
          ...
          % TEXT | PAPER
    \item % Flaw count (TERMS, REDUN): {Gerrard2000a} | {IEEE2022} ISTQB
          The phrase ``continuous automated testing'' \citep[p.~11]{Gerrard2000a}
          is redundant since continuous testing is a subapproach of automated
          testing (\citealp[p.~35]{IEEE2022}; \citealpISTQB{}).
    \item % Flaw count (CATS, AMBI): {IEEE2022} | {IEEE2022} {IEEE2021} {IEEE2017} {SWEBOK2024} ISTQB {KuļešovsEtAl2013} {Perry2006} {PetersAndPedrycz2000} {Gerrard2000a} | {BarbosaEtAl2006}
    ...
    \item % Flaw count (CATS, CONTRA): {SWEBOK2024} | {Kam2008}
    ...
    \item % Flaw count (DEFS, MISS): {Bas2024}
    ...
    \item % Flaw count (SYNS, WRONG): implied by {SharmaEtAl2021}
          ...
          \todo{FIND SOURCES}.
    \item % Flaw count (TERMS, WRONG): {Kam2008}
          \refHelper \citet{Kam2008} misspells ``state-based'' as ``state-base''
          \citetext{pp.~13, 15} and ``stated-base'' \citetext{Tab.~1}.
    \item % Flaw count (CATS, OVER): {Gerrard2000a} | {Gerrard2000a}
          % Label CATS browser-static-and-dynamic
    ...
    \item % Flaw count (DEFS, MISS): {Gerrard2000a}
          ...
          explain them.
    \item % Flaw count (DEFS, MISS): {Gerrard2000a} | {Gerrard2000a}
    ...
    \item % Flaw count (SYNS, WRONG): {SakamotoEtAl2013} | {SneedAndGöschl2000}
    ...
    \item % Flaw count (SYNS, WRONG): {SneedAndGöschl2000}
    ...
    \item % Flaw count (SYNS, WRONG): {SWEBOK2024} {vanVliet2000} | {Kam2008}
    ...
    \item % Flaw count (SYNS, AMBI): {Kam2008} | implied by {Kam2008}
