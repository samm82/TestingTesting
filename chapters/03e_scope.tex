...
are out of scope, as they focus on the \acsVNV{} of design and documentation
respectively.
Likewise, ergonomics testing
...
Furthermore, only some aspects of testing approaches are relevant.  This mainly
manifests as a testing approach that applies to both the \acsVNV{} itself and
...
%% You should NEVER have a single sub-section of a section. You should either
% find another sub-section to have, or not make this a subsection.
...
Static testing seems to be somewhat more ad hoc, in particular some techniques
generate false positives which require human intervention, which makes it
less relevant for own goals (automatic generation of tests).
