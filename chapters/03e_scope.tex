...
mainly manifests as a testing approach that applies to both the \acsVNV{} itself
...
\begin{enumerate}
    \item \emph{Error seeding} is the ``process of intentionally adding
          ...
          which is a part of \acsVNV{} of the \acsVNV{} itself (out of scope),
    ...
    \item ``\emph{Mutation [t]esting} was originally conceived as a
          ...
          which is in the realm of \acsVNV{} of the \acsVNV{} itself (out of
