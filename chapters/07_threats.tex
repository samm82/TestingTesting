...
\begin{itemize}
    ...
    \item \textbf{Drift Over Time:} Since we began recording data
          ...
          constraints. Regarding sources that were updated during our research,
          future researchers could replicate our results by reviewing a
          ``snapshot'' of them from when we reviewed them. However, if future
