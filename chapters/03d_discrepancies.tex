...
\begin{enumerate}
      \item \sig{}: Semantic differences between test approaches
      \item \mod{}: Differences in related information about test approaches
            (such as classifications or supporting information)
      \item \triv{}: Typos or redundant information
\end{enumerate}
