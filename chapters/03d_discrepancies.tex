...
There were three ambiguities around the term ``scalability testing'', given
...
\else \cite[p.~253]{IEEE2017}, \cite{ISTQB}, \cite[p.~5]{IEEE2022},
      \cite[p.~39]{IEEE2021}\fi, so it is a
...
\nameref{scal-discrep} made implicitly) shown in Figure~\ref{fig:perf-graph}.
