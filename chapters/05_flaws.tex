...
and compatibility testing (\Cref{compat-flaw}). \ifnotpaper Finally, we present
    inferred flaws, as described in \Cref{infers}, for completeness in
    \Cref{infer-flaws}; these do not contribute to any counts.
