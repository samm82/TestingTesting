...
The following sections present flaws that we detect automatically
(see \Cref{auto-flaw-analysis}) grouped by \emph{what} information
...
in the future. The domains we focus on here are test approach
