...
syntax and their semantics. Syntactic discrepancies (\Cref{sntxFlaws})
...
other hand, semantic discrepancies (\Cref{smntcFlaws}) describe the
...
discrepancies listed in \Cref{sntxFlaws,smntcFlaws} are not equal,
