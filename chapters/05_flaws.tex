...
in the literature! With more time, we would find definitions for all uncovered
terms as described in \Cref{undef-terms}, \ifnotpaper as well as those that did
    not arise as described in \Cref{future-miss-terms} (including property-based
    testing), \fi but unfortunately, we impose our stopping point artificially.%
\qtodo{Present tense in this paragraph?}
