...
\phantomsection{}\label{flawSubsets}Moreover, certain ``subsets'' of
...
for completeness\else, although we omit the more trivial ``subsets'' from this
\docType{} for brevity\fi.
