...
in the literature!\ifnotpaper\ With more time, we would uncover this along with
    ...
    artificially.\qtodo{Present tense in this paragraph?}\newpage\fi
...
prominent in \Cref{tab:parSyns}\fi.
...
[to be] tested'' \ifnotpaper (\citealp[p.~4, emphasis added]{IEEE2022};
    similar in \citealpISTQB{}; \citealp[p.~121]{Patton2006})%
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.54\linewidth]{assets/graphs/manual/expParSynLegend.pdf}
        \includegraphics[width=0.44\linewidth]{assets/graphs/manual/expParSynGraph.pdf}
        % \vspace{-7mm}
    ...
    \end{figure}\else \cite[p.~4]{IEEE2022} (similar in \citealpISTQB{},
