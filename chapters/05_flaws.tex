...
\Cref{cred,sources}). We also group these flaws by their explicitness (defined
in \Cref{explicitness}) by counting (Obj)ective and (Sub)jective flaws separately.
...
\paragraph{Information is incorrect based on ground truth from another source}
\newpage  % TODO: placeholder

\paragraph{Information is provided with too narrow of a scope}
\parSheetTestFlaw{}

\paragraph{Irrelevant information is provided}
\tolTestFlaw{}
...
% Ground truth: {ISO_IEC2023a} {IEEE2022} {IEEE2021} {IEEE2017} ISTQB
