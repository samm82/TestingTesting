...
flaws. \Cref{tab:flawTable,fig:flawBars} show the source tiers (see \Cref{sources})
...
\begin{enumerate}
    \item Established standards (\Cref{stds}) aren't actually standardized, since:
          ...
          \end{enumerate}
    \item Less standardized (or ``trustworthy''; see \Cref{trust}) documents,
...
\Cref{trust,sources}). The numbers of (Exp)licit and (Imp)licit
