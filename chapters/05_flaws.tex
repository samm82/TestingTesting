...
shown in \Cref{tab:flawMnfsts,tab:smntcFlaws}, respectively, where a given
...
flaws listed in \Cref{flawMnfsts,smntcFlaws} are not equal,
...
in \Cref{tab:flawMnfsts,tab:smntcFlaws} and the counts in \Cref{flawMnfsts,%
...
their sources in \Cref{tab:flawMnfsts,tab:smntcFlaws}. \ifnotpaper The following
