...
In particular, \multiCatIntro{}. We identify \multiCatCount{} such cases, which
we consider flaws as they violate our assumption of orthogonality (see
\Cref{orth-approach}). These flaws mostly involve the category of ``test
\multiCatMax{}'', which shows up in \multiCatMaxCount{} of them. We list all of
these flaws along with their sources in \Cref{tab:multiCats} for completeness,
but the multiple categorizations of experience-based testing are of particular note.
