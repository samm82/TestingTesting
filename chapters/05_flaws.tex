...
manifestation and domain counts\ifnotpaper\ (\Cref{aug-flaw-analysis} outlines
    how this is done)\fi. These subsets include \nameref{func-test-flaw},
\ifnotpaper\nameref{oat-flaw}, \fi \nameref{recov-flaw}, \nameref{scal-flaw},
and \nameref{compat-flaw}. \ifnotpaper Finally, we also present
    \nameref{infer-flaws} for completeness, although these are more subjective
    and thus do not contribute to any counts.
